namespace GameMode.Events
{
    ...
    /// <summary>
    /// Represents the method that will handle the <see cref="BaseMode.PlayerConnected"/>, <see cref="BaseMode.PlayerSpawned"/>, <see cref="BaseMode.PlayerEnterCheckpoint"/>, <see cref="BaseMode.PlayerLeaveCheckpoint"/>, <see cref="BaseMode.PlayerEnterRaceCheckpoint"/>, <see cref="BaseMode.PlayerLeaveRaceCheckpoint"/>, <see cref="BaseMode.PlayerRequestSpawn"/>, <see cref="BaseMode.VehicleDamageStatusUpdated"/>, <see cref="BaseMode.PlayerExitedMenu"/> or <see cref="BaseMode.PlayerUpdate"/> event.
    /// </summary>
    /// <param name="sender">The source of the event.</param>
    ...
    /// <summary>
    /// Represents the method that will handle the <see cref="BaseMode.VehicleDied"/>, <see cref="BaseMode.PlayerExitVehicle"/>, <see cref="BaseMode.VehicleStreamIn"/> or <see cref="BaseMode.VehicleStreamOut"/> event.
    /// </summary>
    /// <param name="sender">The source of the event.</param>
    ...
    /// <summary>
    /// Represents the method that will handle the <see cref="BaseMode.PlayerStreamIn"/> or <see cref="BaseMode.PlayerStreamOut"/> event.
    /// </summary>
    /// <param name="sender">The source of the event.</param>
    ...
    /// <summary>
    /// Represents the method that will handle the <see cref="BaseMode.PlayerTakeDamage"/> or <see cref="BaseMode.PlayerGiveDamage"/> event.
    /// </summary>
    /// <param name="sender">The source of the event.</param>
    ...
    /// <summary>
    /// Represents the method that will handle the <see cref="BaseMode.PlayerClickTextDraw"/> or <see cref="BaseMode.PlayerClickPlayerTextDraw"/> event.
    /// </summary>
    /// <param name="sender">The source of the event.</param>
