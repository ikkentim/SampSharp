...
namespace SampSharp.Streamer.Natives
{
    public static partial class StreamerNative
    {
            ...
            int[] players = null, int maxworlds = -1, int maxinteriors = -1, int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamicObjectEx",
                __arglist(
            ...
            int maxworlds = -1, int maxinteriors = -1, int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamicPickupEx",
                __arglist(
            ...
            int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamicCPEx",
            ...
            int[] players = null, int maxworlds = -1, int maxinteriors = -1, int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamicRaceCPEx",
                __arglist(
            ...
            int[] interiors = null, int[] players = null, int maxworlds = -1, int maxinteriors = -1, int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamicMapIconEx",
                __arglist(
            ...
            int[] players = null, int maxworlds = -1, int maxinteriors = -1, int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamic3DTextLabelEx",
                __arglist(
            ...
            int[] interiors = null, int[] players = null, int maxworlds = -1, int maxinteriors = -1, int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamicCircleEx",
            ...
            int[] interiors = null, int[] players = null, int maxworlds = -1, int maxinteriors = -1, int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamicRectangleEx",
            ...
            int[] interiors = null, int[] players = null, int maxworlds = -1, int maxinteriors = -1, int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamicSphereEx",
            ...
            int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamicCubeEx",
                __arglist(
            ...
            int[] players = null, int maxworlds = -1, int maxinteriors = -1, int maxplayers = -1)
        {
            ...
            return Native.CallNative("CreateDynamicPolygonEx",
