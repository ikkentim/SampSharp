...
#pragma clang diagnostic ignored                                                                                       \
    "-Wreturn-type-c-linkage" // <FUNC> has C-linkage specified, but returns user-defined type '<TYPE>' which is
...
PROXY_EVENT_HANDLER_END(NPCEventHandler, onNPCFinishMove, onNPCCreate, onNPCDestroy, onNPCSpawn, onNPCRespawn,
                        onNPCWeaponStateChange, onNPCTakeDamage, onNPCGiveDamage, onNPCDeath, onNPCShotMissed,
                        onNPCShotPlayer, onNPCShotNPC, onNPCShotVehicle, onNPCShotObject, onNPCShotPlayerObject,
                        onNPCPlaybackStart, onNPCPlaybackEnd, onNPCFinishNodePoint, onNPCFinishNode, onNPCChangeNode,
                        onNPCFinishMovePathPoint, onNPCFinishMovePath)
...
PROXY_EVENT_HANDLER_END(VehicleEventHandler, onVehicleStreamIn, onVehicleStreamOut, onVehicleDeath,
                        ...
                        onVehicleMod, onVehicleRespray, onEnterExitModShop, onVehicleSpawn, onUnoccupiedVehicleUpdate,
