...
bool ManagedHost::getEntryPoint(const StringView entry_type_name, const StringView name, void** delegate_ptr,
                                const char** error_ptr) const
{
    ...
    const int rc =
        load_assembly_and_get_function_pointer_fptr(assem_path_.c_str(), entry_type_name_w.c_str(), name_w.c_str(),
...
const char* ManagedHost::get_error(int code) const
{
    ...
    case 0x00000002:
        return "Initialization was successful, but another host context is already initialized and the requested "
               "context specified runtime properties which are not the same";
    case 0x80008081:
        return "One or more arguments are invalid";
    case 0x80008082:
        return "Failed to load a hosting component";
    case 0x80008083:
        return "One of the hosting components is missing";
    case 0x80008084:
        return "One of the hosting components is missing a required entry point";
    case 0x80008085:
        return "Failed to get the path of the current hosting component and determine the .NET installation location";
    case 0x80008087:
        return "The `coreclr` library could not be found";
    case 0x80008088:
        return "Failed to load the `coreclr` library or finding one of the required entry points";
    case 0x80008089:
        return "Call to `coreclr_initialize` failed";
    case 0x8000808a:
        return "Call to `coreclr_execute_assembly` failed";
    case 0x8000808b:
    ...
    case 0x80008096:
        return "Failed to find a compatible framework version";
    case 0x80008097:
        return "Host command failed";
    case 0x80008098:
        return "Buffer provided to a host API is too small to fit the requested value";
    case 0x8000809a:
        return "Application path imprinted in `apphost` doesn't exist";
    case 0x8000809b:
        return "Failed to find the requested SDK";
    case 0x8000809c:
        return "Application has multiple references to the same framework which are not compatible";
    case 0x8000809d:
        return "[internal usage only]";
    case 0x8000809f:
        return "Error extracting single-file bundle";
    case 0x800080a0:
        return "Error reading or writing files during single-file bundle extraction";
    case 0x800080a1:
        return "The application's `.runtimeconfig.json` contains a runtime property which is produced by the hosting "
               "layer";
    case 0x800080a2:
        return "Feature which requires certain version of the hosting layer was used on a version which doesn't "
               "support it";
    case 0x800080a3:
        return "Current state is incompatible with the requested operation";
    case 0x800080a4:
    ...
    case 0x800080a6:
        return "Hosting API does not support the requested scenario";
    case 0x800080a7:
        return "Support for a requested feature is disabled";
