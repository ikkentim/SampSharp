...
{
    /// <summary>
    /// Adds the system of the specified <paramref name="type" /> as a singleton and enables the system in the system registry.
    /// </summary>
    ...
    /// <summary>
    /// Adds the all types which implement <see cref="ISystem" /> in the calling assembly as singletons and enable the systems in the system registry.
    /// </summary>
    /// <param name="services">The service collection to add the systems to.</param>
    /// <returns>A reference to this instance after the operation has completed.</returns>
