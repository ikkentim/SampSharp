...
/// <summary>
/// Represents a response to a <see cref="ListDialog" />.
/// </summary>
/// <remarks>
...
public struct ListDialogResponse(DialogResponse response, int itemIndex, ListDialogRow? item)
{
    /// <summary>
    ...
    /// </summary>
    public ListDialogRow? Item { get; } = item;
}
