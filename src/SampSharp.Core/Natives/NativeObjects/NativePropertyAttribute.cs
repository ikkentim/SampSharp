...
/// <summary>Indicates a property represents a native setter/getter.</summary>
[AttributeUsage(AttributeTargets.Property)]
public class NativePropertyAttribute : Attribute
{
    /// <summary>Initializes a new instance of the <see cref="NativePropertyAttribute" /> class.</summary>
