...
namespace SampSharp.Core.Natives.NativeObjects.FastNatives
{
    ...
    public static class NativeUtils
    {
        ...
        public static unsafe int IntPointerToInt(int* ptr) => (int) (IntPtr) ptr;
        ...
        /// <returns>The cast integer.</returns>
        public static unsafe int BytePointerToInt(byte* ptr) => (int) (IntPtr) ptr;
        ...
        private static void CopySpan(Span<int> span, int[] arr) => span.CopyTo(new Span<int>(arr));
