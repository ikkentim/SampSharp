...
/// <summary>Provides functions used by native proxies generated by native object proxy generator.</summary>
public static class NativeUtils
{
    /// <summary>Casts an integer pointer to an integer.</summary>
    ...
    /// <summary>Casts a byte pointer to an integer.</summary>
    ...
    /// <summary>Gets the byte count of the specified input string based on the currently active encoding.</summary>
    ...
    /// <summary>Gets the bytes of the specified input string based on the currently active encoding.</summary>
    ...
    /// <summary>Gets the string from the specified bytes based on the currently active encoding.</summary>
    ...
    /// <summary>Synchronizes an invocation to a native pointer.</summary>
    ...
    public static unsafe int SynchronizeInvoke(ISynchronizationProvider synchronizationProvider, IntPtr native, string format, int* data)
    {
        int result = default;
        synchronizationProvider.Invoke(() => result = Interop.FastNativeInvoke(native, format, data));
        return result;
    }


    /// <summary>Converts an array to on span of integers.</summary>
    /// <param name="array">The array to convert.</param>
    /// <param name="length">The length of the data to convert.</param>
    /// <returns>The span of integers.</returns>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Major Code Smell",
        "S1871:Two branches in a conditional structure should not have exactly the same implementation", Justification = "False message")]
    ...
    /// <summary>Converts a span of integers to an array of type <typeparamref name="T" />.</summary>
    ...
    /// <summary>Assigns variable arguments values to the specified buffers.</summary>
    ...
    /// <summary>Appends the format for specified variable arguments to the specified format.</summary>
