...
public readonly struct Vector4 : IEquatable<Vector4>
{
    ...
    /// <summary>Gets the X component of this <see cref="Vector4" />.</summary>
    public float X { get; }

    /// <summary>Gets the Y component of this <see cref="Vector4" />.</summary>
    public float Y { get; }

    /// <summary>Gets the Z component of this <see cref="Vector4" />.</summary>
    public float Z { get; }

    /// <summary>Gets the W component of this <see cref="Vector4" />.</summary>
    public float W { get; }

    /// <summary>Returns an empty <see cref="Vector4" />.</summary>
    public static Vector4 Zero { get; } = new(0, 0, 0, 0);

    /// <summary>Returns a <see cref="Vector4" /> with each component set to 1.</summary>
    ...
    /// <summary>Gets the squared length of this <see cref="Vector4" />.</summary>
    public float LengthSquared => DistanceSquared(this, Zero);

    /// <summary>Gets whether this <see cref="Vector4" /> is empty.</summary>
    public bool IsEmpty => X.Equals(0) && Y.Equals(0) && Z.Equals(0);

    /// <summary>Gets the distance to another <see cref="Vector4" />.</summary>
    ...
    /// <summary>Creates a new <see cref="Vector4" /> instance with the components normalized to a single unit.</summary>
    ...
    /// <summary>
    /// Creates a new <see cref="Vector4" /> that contains the cartesian coordinates of a vector specified in barycentric coordinates and relative to
    /// 4d-triangle.
    /// </summary>
    ...
    {
        return new Vector4(MathHelper.Clamp(value1.X, min.X, max.X), MathHelper.Clamp(value1.Y, min.Y, max.Y), MathHelper.Clamp(value1.Z, min.Z, max.Z),
    ...
    {
        return new Vector4(MathHelper.Max(value1.X, value2.X), MathHelper.Max(value1.Y, value2.Y), MathHelper.Max(value1.Z, value2.Z),
    ...
    {
        return new Vector4(MathHelper.Min(value1.X, value2.X), MathHelper.Min(value1.Y, value2.Y), MathHelper.Min(value1.Z, value2.Z),
    ...
    {
        return new Vector4(MathHelper.SmoothStep(value1.X, value2.X, amount), MathHelper.SmoothStep(value1.Y, value2.Y, amount),
    ...
    {
        return new Vector4(value.X * matrix.M11 + value.Y * matrix.M21 + matrix.M41, value.X * matrix.M12 + value.Y * matrix.M22 + matrix.M42,
            value.X * matrix.M13 + value.Y * matrix.M23 + matrix.M43, value.X * matrix.M14 + value.Y * matrix.M24 + matrix.M44);
    }
    ...
    {
        return new Vector4(value.X * matrix.M11 + value.Y * matrix.M21 + value.Z * matrix.M31 + value.W * matrix.M41,
    ...
    /// <summary>Adds the left <see cref="Vector4" />'s components to the right <see cref="Vector4" />'s components and stores it in a new <see cref="Vector4" />.</summary>
    ...
    /// <summary>
    /// Subtracts the right <see cref="Vector4" />'s components from the left <see cref="Vector4" />'s components and stores it in a new
    /// <see cref="Vector4" />.
    /// </summary>
    /// <param name="left">A <see cref="Vector4" />.</param>
    /// <param name="right">A <see cref="Vector4" />.</param>
    ...
    /// <summary>Creates a <see cref="Vector4" /> with the components set to the negative values of the given <paramref name="vector" />'s components.</summary>
    ...
    /// <summary>Multiplies the components <see cref="Vector4" /> by the given scalar and stores them in a new <see cref="Vector4" />.</summary>
    ...
    /// <summary>
    /// Multiplies the components <see cref="Vector4" /> by the components of the right <see cref="Vector4" /> and stores them in a new <see cref="Vector4" />
    /// .
    /// </summary>
    /// <param name="left">A <see cref="Vector4" />.</param>
    /// <param name="right">A <see cref="Vector4" />.</param>
    ...
    /// <summary>Divides the components <see cref="Vector4" /> by the given scalar and stores them in a new <see cref="Vector4" />.</summary>
    /// <param name="vector">The <see cref="Vector4" />.</param>
    /// <param name="scalar">The scalar.</param>
    /// <returns>The new <see cref="Vector4" />.</returns>
    public static Vector4 operator /(Vector4 vector, float scalar)
    ...
    /// <summary>Divides the components <see cref="Vector4" /> by the components of the right <see cref="Vector4" /> and stores them in a new <see cref="Vector4" />.</summary>
    ...
    /// <summary>Tests whether all components of both <see cref="Vector4" /> are equivalent.</summary>
    ...
    /// <summary>Tests whether any component of both <see cref="Vector4" /> are not equivalent.</summary>
    /// <param name="left">Instance of <see cref="Vector4" /> to compare.</param>
    /// <param name="right">Instance of <see cref="Vector4" /> to compare.</param>
