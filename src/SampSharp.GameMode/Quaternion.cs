...
/// <summary>Represents a quaternion rotation.</summary>
public readonly struct Quaternion : IEquatable<Quaternion>
{
    /// <summary>Gets the x-coordinate of this <see cref="Quaternion" />.</summary>
    public float X { get; }

    /// <summary>Gets the y-coordinate of this <see cref="Quaternion" />.</summary>
    public float Y { get; }

    /// <summary>Gets the z-coordinate of this <see cref="Quaternion" />.</summary>
    public float Z { get; }

    /// <summary>Gets the rotation component of this <see cref="Quaternion" />.</summary>
    public float W { get; }
    ...
    public static Quaternion Concatenate(Quaternion value1, Quaternion value2)
    {
        ...
        return new Quaternion(x2 * w1 + x1 * w2 + (y2 * z1 - z2 * y1), y2 * w1 + y1 * w2 + (z2 * x1 - x2 * z1), z2 * w1 + z1 * w2 + (x2 * y1 - y2 * x1),
    ...
    public static Quaternion CreateFromRotationMatrix(Matrix matrix)
    {
        ...
        if (scale > 0.0f)
        {
            ...
            return new Quaternion(-(matrix.M23 - matrix.M32) * sqrt, -(matrix.M31 - matrix.M13) * sqrt, -(matrix.M12 - matrix.M21) * sqrt, w);
        }
        ...
        if (matrix.M11 >= matrix.M22 && matrix.M11 >= matrix.M33)
        {
            ...
            return new Quaternion(-0.5f * sqrt, -(matrix.M12 + matrix.M21) * half, -(matrix.M13 + matrix.M31) * half, (matrix.M23 - matrix.M32) * half);
        }
        ...
        if (matrix.M22 > matrix.M33)
        {
            ...
            return new Quaternion(-(matrix.M21 + matrix.M12) * half, -0.5f * sqrt, -(matrix.M32 + matrix.M23) * half, (matrix.M31 - matrix.M13) * half);
        }

        sqrt = (float)Math.Sqrt(1.0f + matrix.M33 - matrix.M11 - matrix.M22);
        half = 0.5f / sqrt;

        return new Quaternion(-(matrix.M31 + matrix.M13) * half, -(matrix.M32 + matrix.M23) * half, -0.5f * sqrt, (matrix.M12 - matrix.M21) * half);
    }
    ...
    public static Quaternion CreateFromYawPitchRoll(float yaw, float pitch, float roll)
    {
        ...
        return new Quaternion(cosYaw * sinPitch * cosRoll + sinYaw * cosPitch * sinRoll, sinYaw * cosPitch * cosRoll - cosYaw * sinPitch * sinRoll,
            cosYaw * cosPitch * sinRoll - sinYaw * sinPitch * cosRoll, cosYaw * cosPitch * cosRoll + sinYaw * sinPitch * sinRoll);
    }
    ...
    public static Quaternion Lerp(Quaternion quaternion1, Quaternion quaternion2, float amount)
    {
        ...
        if (num5 >= 0f)
            quaternion = new Quaternion(num2 * quaternion1.X + num * quaternion2.X, num2 * quaternion1.Y + num * quaternion2.Y,
                num2 * quaternion1.Z + num * quaternion2.Z, num2 * quaternion1.W + num * quaternion2.W);
        else
            quaternion = new Quaternion(num2 * quaternion1.X - num * quaternion2.X, num2 * quaternion1.Y - num * quaternion2.Y,
                num2 * quaternion1.Z - num * quaternion2.Z, num2 * quaternion1.W - num * quaternion2.W);
    ...
    public static Quaternion Slerp(Quaternion quaternion1, Quaternion quaternion2, float amount)
    {
        ...
        else
        {
            ...
            num2 = flag
                ? (float)-Math.Sin(num * num5) * num6
                : (float)Math.Sin(num * num5) * num6;
        }

        return new Quaternion(num3 * quaternion1.X + num2 * quaternion2.X, num3 * quaternion1.Y + num2 * quaternion2.Y,
            num3 * quaternion1.Z + num2 * quaternion2.Z, num3 * quaternion1.W + num2 * quaternion2.W);
    }
    ...
    public static Quaternion operator /(Quaternion quaternion1, Quaternion quaternion2)
    {
        ...
        return new Quaternion(x * num + num4 * w + num13, y * num + num3 * w + num12, z * num + num2 * w + num11, w * num - num10);
    }
    ...
    {
        return quaternion1.X.Equals(quaternion2.X) && quaternion1.Y.Equals(quaternion2.Y) && quaternion1.Z.Equals(quaternion2.Z) &&
    ...
    public static Quaternion operator *(Quaternion quaternion1, Quaternion quaternion2)
    {
        ...
        return new Quaternion(x * num + num4 * w + num12, y * num + num3 * w + num11, z * num + num2 * w + num10, w * num - num9);
    }
