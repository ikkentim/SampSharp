...
/// <summary>Represents errors which occur if a player disconnects during a certain procedure.</summary>
[Serializable]
public class PlayerDisconnectedException : Exception
{
    ...
    /// <summary>Initializes a new instance of the <see cref="T:PlayerDisconnectedException" /> class with a specified error message.</summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:PlayerDisconnectedException" /> class with a specified error message and a reference to the inner
    ...
    /// <summary>Initializes a new instance of the <see cref="PlayerDisconnectedException" /> class.</summary>
