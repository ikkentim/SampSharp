...
/// <summary>Contains a set priority events.</summary>
public sealed class PriorityKeyHandler
{
    /// <summary>Occurs as first handler.</summary>
    public event EventHandler<CancelableEventArgs> HighPriority;

    /// <summary>Occurs as second handler, if the no <see cref="HighPriority" /> have canceled the event.</summary>
    public event EventHandler<CancelableEventArgs> NormalPriority;

    /// <summary>Occurs as third handler, if the no <see cref="HighPriority" /> or <see cref="NormalPriority" /> have canceled the event.</summary>
