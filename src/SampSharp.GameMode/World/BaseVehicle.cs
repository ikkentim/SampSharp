...
/// <summary>Represents a SA-MP vehicle.</summary>
public partial class BaseVehicle : IdentifiedPool<BaseVehicle>, IWorldObject
{
    ...
    /// <summary>Gets an instance of <see cref="VehicleModelInfo" /> about this <see cref="BaseVehicle" />.</summary>
    public VehicleModelInfo ModelInfo => VehicleModelInfo.ForVehicle(this);

    /// <summary>Gets the driver of this <see cref="BaseVehicle" />.</summary>
    public BasePlayer Driver
    {
        get { return BasePlayer.All.FirstOrDefault(p => p.Vehicle == this && p.VehicleSeat == 0); }
    }

    /// <summary>Gets the passengers of this <see cref="BaseVehicle" />. (not the driver)</summary>
    public IEnumerable<BasePlayer> Passengers
    {
        get
        {
            return BasePlayer.All.Where(p => p.Vehicle == this)
                .Where(player => player.VehicleSeat > 0);
        }
    }

    /// <summary>Gets the size of the vehicles pool.</summary>
    public static int PoolSize => VehicleInternal.Instance.GetVehiclePoolSize();

    /// <summary>Gets whether this <see cref="BaseVehicle" /> has been created and still is alive.</summary>
    public virtual bool IsValid => VehicleInternal.Instance.IsValidVehicle(Id);

    /// <summary>Gets or sets the Z angle of this <see cref="BaseVehicle" />.</summary>
    ...
    /// <summary>Gets the model ID of this <see cref="BaseVehicle" />.</summary>
    public virtual VehicleModelType Model => (VehicleModelType)VehicleInternal.Instance.GetVehicleModel(Id);

    /// <summary>Gets whether this <see cref="BaseVehicle" /> has a trailer attached to it.</summary>
    public virtual bool HasTrailer => VehicleInternal.Instance.IsTrailerAttachedToVehicle(Id);

    /// <summary>Gets or sets the the trailer attached to this <see cref="BaseVehicle" />.</summary>
    ...
    /// <summary>Gets or sets the velocity at which this <see cref="BaseVehicle" /> is moving.</summary>
    ...
    /// <summary>Gets or sets the virtual world of this <see cref="BaseVehicle" />.</summary>
    ...
    /// <summary>Gets or sets this <see cref="BaseVehicle" />'s engine status. If True, the engine is running.</summary>
    ...
    /// <summary>Gets or sets this <see cref="BaseVehicle" />'s lights' state. If True the lights are on.</summary>
    ...
    /// <summary>Gets or sets this <see cref="BaseVehicle" />'s alarm state. If True the alarm is (or was) sounding.</summary>
    ...
    /// <summary>Gets or sets the lock status of the doors of this <see cref="BaseVehicle" />. If True the doors are locked.</summary>
    ...
    /// <summary>Gets or sets the bonnet/hood status of this <see cref="BaseVehicle" />. If True, it's open.</summary>
    ...
    /// <summary>Gets or sets the boot/trunk status of this <see cref="BaseVehicle" />. True means it is open.</summary>
    ...
    /// <summary>Gets or sets the objective status of this <see cref="BaseVehicle" />. True means the objective is on.</summary>
    ...
    /// <summary>Gets or sets the rotation of this <see cref="BaseVehicle" />.</summary>
    ...
    /// <summary>Gets or sets the health of this <see cref="BaseVehicle" />.</summary>
    ...
    /// <summary>Gets or sets the position of this <see cref="BaseVehicle" />.</summary>
    ...
    /// <summary>
    /// Occurs when the <see cref="OnDeath" /> is being called. This callback is called when this <see cref="BaseVehicle" /> is destroyed - either by
    /// exploding or becoming submerged in water.
    /// </summary>
    public event EventHandler<PlayerEventArgs> Died;

    /// <summary>
    /// Occurs when the <see cref="OnPlayerEnter" /> is being called. This callback is called when a <see cref="BasePlayer" /> starts to enter this
    /// <see cref="BaseVehicle" />, meaning the player is not in vehicle yet at the time this callback is called.
    /// </summary>
    public event EventHandler<EnterVehicleEventArgs> PlayerEnter;

    /// <summary>
    /// Occurs when the <see cref="OnPlayerExit" /> is being called. This callback is called when a <see cref="BasePlayer" /> exits a
    /// <see cref="BaseVehicle" />.
    /// </summary>
    public event EventHandler<PlayerVehicleEventArgs> PlayerExit;

    /// <summary>Occurs when the <see cref="OnMod" /> is being called. This callback is called when this <see cref="BaseVehicle" /> is modded.</summary>
    public event EventHandler<VehicleModEventArgs> Mod;

    /// <summary>
    /// Occurs when the <see cref="OnPaintjobApplied" /> is being called. Called when a <see cref="BasePlayer" /> changes the paintjob of this
    /// <see cref="BaseVehicle" /> (in a modshop).
    /// </summary>
    public event EventHandler<VehiclePaintjobEventArgs> PaintjobApplied;

    /// <summary>
    /// Occurs when the <see cref="OnResprayed" /> is being called. The callback name is deceptive, this callback is called when a <see cref="BasePlayer" />
    /// exits a mod shop with this <see cref="BaseVehicle" />, regardless of whether the vehicle's colors were changed, and is NEVER called for pay 'n' spray garages.
    /// </summary>
    public event EventHandler<VehicleResprayedEventArgs> Resprayed;

    /// <summary>
    /// Occurs when the <see cref="OnDamageStatusUpdated" /> is being called. This callback is called when a element of this <see cref="BaseVehicle" /> such
    /// as doors, tires, panels, or lights get damaged.
    /// </summary>
    public event EventHandler<PlayerEventArgs> DamageStatusUpdated;

    /// <summary>
    /// Occurs when the <see cref="OnUnoccupiedUpdate" /> is being called. This callback is called every time this <see cref="BaseVehicle" /> updates the
    /// server with their status while it is unoccupied.
    /// </summary>
    public event EventHandler<UnoccupiedVehicleEventArgs> UnoccupiedUpdate;

    /// <summary>
    /// Occurs when the <see cref="OnStreamIn" /> is being called. Called when a <see cref="BaseVehicle" /> is streamed to a <see cref="BasePlayer" />'s
    /// client.
    /// </summary>
    public event EventHandler<PlayerEventArgs> StreamIn;

    /// <summary>
    /// Occurs when the <see cref="OnStreamOut" /> is being called. This callback is called when a <see cref="BaseVehicle" /> is streamed out from some
    /// <see cref="BasePlayer" /> 's client.
    /// </summary>
    public event EventHandler<PlayerEventArgs> StreamOut;

    /// <summary>
    /// Occurs when the <see cref="OnTrailerUpdate" /> is being called. This callback is called when a <see cref="BasePlayer" /> sent a trailer update about
    /// this <see cref="BaseVehicle" />.
    /// </summary>
    public event EventHandler<TrailerEventArgs> TrailerUpdate;

    /// <summary>Occurs when the <see cref="OnSirenStateChanged" /> is being called. This callback is called when this <see cref="BaseVehicle" />'s siren is toggled.</summary>
    public event EventHandler<SirenStateEventArgs> SirenStateChanged;

    /// <summary>
    /// This function can be used to calculate the distance (as a float) between this <see cref="BaseVehicle" /> and another map coordinate. This can be
    /// useful to detect how far a vehicle away is from a location.
    /// </summary>
    ...
    public static BaseVehicle Create(VehicleModelType vehicletype, Vector3 position, float rotation, int color1, int color2, int respawnDelay = -1,
        bool addAlarm = false)
    {
    ...
    /// <param name="addAlarm">If true, enables the vehicle to have a siren, providing the vehicle has a horn.</param>
    /// <returns> The <see cref="BaseVehicle" /> created.</returns>
    public static BaseVehicle CreateStatic(VehicleModelType vehicleType, Vector3 position, float rotation, int color1, int color2, int respawnDelay,
        bool addAlarm = false)
    {
        var service = BaseMode.Instance.Services.GetService<IVehicleFactory>();
    ...
    /// <summary>Checks if this <see cref="BaseVehicle" /> is streamed in for a <see cref="BasePlayer" />.</summary>
    ...
    /// <summary>Returns this <see cref="BaseVehicle" />'s rotation on all axis as a quaternion.</summary>
    ...
    public virtual void GetRotationQuat(out float w, out float x, out float y, out float z)
    {
        AssertNotDisposed();
    ...
    /// <summary>Set the parameters of this <see cref="BaseVehicle" /> for a <see cref="BasePlayer" />.</summary>
    ...
    public virtual void SetParametersForPlayer(BasePlayer player, bool objective, bool doorslocked)
    {
        AssertNotDisposed();
    ...
    /// <summary>Sets this <see cref="BaseVehicle" />'s parameters for all players.</summary>
    ...
    public virtual void SetParameters(bool engine, bool lights, bool alarm, bool doors, bool bonnet, bool boot, bool objective)
    {
        ...
        VehicleInternal.Instance.SetVehicleParamsEx(Id, engine
            ? 1
            : 0, lights
            ? 1
            : 0, alarm
        ...
        VehicleParameterValue bonnet, VehicleParameterValue boot, VehicleParameterValue objective)
    {
        ...
        VehicleInternal.Instance.SetVehicleParamsEx(Id, (int)engine, (int)lights, (int)alarm, (int)doors, (int)bonnet, (int)boot, (int)objective);
    }

    /// <summary>Gets this <see cref="BaseVehicle" />'s parameters.</summary>
    ...
    public virtual void SetDoorsParameters(bool driver, bool passenger, bool backleft, bool backright)
    {
        ...
        VehicleInternal.Instance.SetVehicleParamsCarDoors(Id, driver
            ? 1
            : 0, passenger
            ? 1
            : 0, backleft
    ...
    public virtual void SetWindowsParameters(bool driver, bool passenger, bool backleft, bool backright)
    {
        ...
        VehicleInternal.Instance.SetVehicleParamsCarWindows(Id, driver
            ? 1
            : 0, passenger
            ? 1
            : 0, backleft
    ...
    /// <summary>Sets this <see cref="BaseVehicle" /> back to the position at where it was created.</summary>
    ...
    /// <summary>Links this <see cref="BaseVehicle" /> to the interior. This can be used for example for an arena/stadium.</summary>
    ...
    /// <summary>Remove a component from the <see cref="BaseVehicle" />.</summary>
    ...
    /// <summary>Change this <see cref="BaseVehicle" />'s primary and secondary colors.</summary>
    ...
    /// <summary>Set this <see cref="BaseVehicle" />'s numberplate, which supports color embedding.</summary>
    ...
    /// <summary>Retrieves the installed component ID from this <see cref="BaseVehicle" /> in a specific slot.</summary>
    ...
    /// <summary>Fully repairs this <see cref="BaseVehicle" />, including visual damage (bumps, dents, scratches, popped tires etc.).</summary>
    ...
    /// <summary>Sets the angular velocity of this <see cref="BaseVehicle" />.</summary>
    ...
    /// <summary>Retrieve the damage statuses of this <see cref="BaseVehicle" />.</summary>
    ...
    /// <summary>Sets the various visual damage statuses of this <see cref="BaseVehicle" />, such as popped tires, broken lights and damaged panels.</summary>
    ...
    /// <summary>Raises the <see cref="Spawn" /> event.</summary>
    ...
    /// <summary>Raises the <see cref="PlayerEnter" /> event.</summary>
    ...
    /// <summary>Raises the <see cref="PlayerExit" /> event.</summary>
    ...
    /// <summary>Raises the <see cref="Mod" /> event.</summary>
    ...
    /// <summary>Raises the <see cref="PaintjobApplied" /> event.</summary>
    ...
    /// <summary>Raises the <see cref="Resprayed" /> event.</summary>
    ...
    /// <summary>Raises the <see cref="DamageStatusUpdated" /> event.</summary>
    /// <param name="e">An <see cref="PlayerEventArgs" /> that contains the event data. </param>
    ...
    /// <summary>Raises the <see cref="UnoccupiedUpdate" /> event.</summary>
    ...
    /// <summary>Raises the <see cref="SirenStateChanged" /> event.</summary>
