...
namespace SampSharp.GameMode.World
{
    public partial class PlayerObject
    {
        private static class Internal
        {
            ...
            public static readonly AttachCameraToPlayerObjectImpl
                NativeAttachCameraToPlayerObject = null;

            [Native("EditPlayerObject")]
            public static readonly EditPlayerObjectImpl EditPlayerObject = null;

            [Native("CreatePlayerObject")]
            public static readonly CreatePlayerObjectImpl CreatePlayerObject = null;


            [Native("AttachPlayerObjectToPlayer")]
            public static readonly AttachPlayerObjectToPlayerImpl
                AttachPlayerObjectToPlayer = null;

            [Native("AttachPlayerObjectToVehicle")]
            public static readonly AttachPlayerObjectToVehicleImpl
                AttachPlayerObjectToVehicle = null;

            [Native("SetPlayerObjectPos")]
            public static readonly SetPlayerObjectPosImpl SetPlayerObjectPos = null;
            [Native("GetPlayerObjectPos")]
            public static readonly GetPlayerObjectPosImpl GetPlayerObjectPos = null;
            [Native("SetPlayerObjectRot")]
            public static readonly SetPlayerObjectRotImpl SetPlayerObjectRot = null;
            [Native("GetPlayerObjectRot")]
            public static readonly GetPlayerObjectRotImpl GetPlayerObjectRot = null;
            [Native("GetPlayerObjectModel")]
            public static readonly GetPlayerObjectModelImpl GetPlayerObjectModel = null;

            [Native("SetPlayerObjectNoCameraCol")]
            public static readonly SetPlayerObjectNoCameraColImpl
                SetPlayerObjectNoCameraCol = null;

            [Native("IsValidPlayerObject")]
            public static readonly IsValidPlayerObjectImpl IsValidPlayerObject = null;
            [Native("DestroyPlayerObject")]
            public static readonly DestroyPlayerObjectImpl DestroyPlayerObject = null;
            [Native("MovePlayerObject")]
            public static readonly MovePlayerObjectImpl MovePlayerObject = null;
            [Native("StopPlayerObject")]
            public static readonly StopPlayerObjectImpl StopPlayerObject = null;
            [Native("IsPlayerObjectMoving")]
            public static readonly IsPlayerObjectMovingImpl IsPlayerObjectMoving = null;

            [Native("SetPlayerObjectMaterial")]
            public static readonly SetPlayerObjectMaterialImpl SetPlayerObjectMaterial =
                null;

            [Native("SetPlayerObjectMaterialText")]
            public static readonly SetPlayerObjectMaterialTextImpl
                SetPlayerObjectMaterialText = null;

            [Native("SelectObject")]
            public static readonly SelectObjectImpl SelectObject = null;
