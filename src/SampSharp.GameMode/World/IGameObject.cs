...
/// <summary>Contains methods and properties for accessing a SA-MP object of any type.</summary>
public interface IGameObject : IWorldObject
{
    ...
    void SetMaterialText(int materialindex, string text, ObjectMaterialSize materialsize, string fontface, int fontsize, bool bold, Color foreColor,
