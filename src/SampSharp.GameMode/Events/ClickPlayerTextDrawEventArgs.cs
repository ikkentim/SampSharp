...
namespace SampSharp.GameMode.Events
{
    ...
    /// </summary>
    public class ClickPlayerTextDrawEventArgs : PlayerEventArgs
    {
        /// <summary>
        ...
        public ClickPlayerTextDrawEventArgs(BasePlayer player, PlayerTextDraw playerTextDraw) : base(player)
        {
