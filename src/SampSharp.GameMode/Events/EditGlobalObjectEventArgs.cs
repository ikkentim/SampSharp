...
/// <summary>
/// Provides data for the <see cref="BaseMode.PlayerEditGlobalObject" />, <see cref="BasePlayer.EditGlobalObject" /> or <see cref="GlobalObject.Edited" />
/// event.
/// </summary>
public class EditGlobalObjectEventArgs : PositionEventArgs
{
    /// <summary>Initializes a new instance of the <see cref="EditGlobalObjectEventArgs" /> class.</summary>
    /// <param name="player">The player.</param>
    /// <param name="object">The global object.</param>
    /// <param name="response">The response.</param>
    /// <param name="position">The position.</param>
    /// <param name="rotation">The rotation.</param>
    public EditGlobalObjectEventArgs(BasePlayer player, GlobalObject @object, EditObjectResponse response, Vector3 position, Vector3 rotation) : base(position)
    {
        Player = player;
        Object = @object;
