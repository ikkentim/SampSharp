...
/// <summary>Represents a tablist (table) dialog.</summary>
public class TablistDialog : Dialog, IList<IEnumerable<string>>
{
    ...
    public TablistDialog(string caption, int columnCount, string button1, string button2 = null) : base(DialogStyle.Tablist, caption, button1, button2)
    {
        if (columnCount <= 0)
    ...
    /// <param name="button1">The text on the left button.</param>
    /// <param name="button2">The text on the right button. Leave it blank to hide it.</param>
    public TablistDialog(string caption, IEnumerable<string> columns, string button1, string button2 = null) : base(DialogStyle.TablistHeaders, caption,
        button1, button2)
    {
    ...
    /// <summary>Adds a row with the specified cells.</summary>
    ...
    {
        return _rows.Select(row => row.Split('\t'))
