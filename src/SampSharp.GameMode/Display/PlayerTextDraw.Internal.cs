...
namespace SampSharp.GameMode.Display
{
    public partial class PlayerTextDraw
    {
        ...
        private static class Internal
        {
            ...
            public static readonly CreatePlayerTextDrawImpl CreatePlayerTextDraw =
                null;

            [Native("PlayerTextDrawDestroy")]
            public static readonly PlayerTextDrawDestroyImpl PlayerTextDrawDestroy =
                null;

            [Native("PlayerTextDrawLetterSize")]
            public static readonly PlayerTextDrawLetterSizeImpl
                PlayerTextDrawLetterSize = null;

            [Native("PlayerTextDrawTextSize")]
            public static readonly PlayerTextDrawTextSizeImpl PlayerTextDrawTextSize
                =
                null;

            [Native("PlayerTextDrawAlignment")]
            public static readonly PlayerTextDrawAlignmentImpl
                PlayerTextDrawAlignment
                =
                null;

            [Native("PlayerTextDrawColor")]
            public static readonly PlayerTextDrawColorImpl PlayerTextDrawColor = null;

            [Native("PlayerTextDrawUseBox")]
            public static readonly PlayerTextDrawUseBoxImpl PlayerTextDrawUseBox =
                null;

            [Native("PlayerTextDrawBoxColor")]
            public static readonly PlayerTextDrawBoxColorImpl PlayerTextDrawBoxColor
                =
                null;

            [Native("PlayerTextDrawSetShadow")]
            public static readonly PlayerTextDrawSetShadowImpl
                PlayerTextDrawSetShadow
                =
                null;

            [Native("PlayerTextDrawSetOutline")]
            public static readonly PlayerTextDrawSetOutlineImpl
                PlayerTextDrawSetOutline = null;

            [Native("PlayerTextDrawBackgroundColor")]
            public static readonly PlayerTextDrawBackgroundColorImpl
                PlayerTextDrawBackgroundColor = null;

            [Native("PlayerTextDrawFont")]
            public static readonly PlayerTextDrawFontImpl PlayerTextDrawFont = null;

            [Native("PlayerTextDrawSetProportional")]
            public static readonly PlayerTextDrawSetProportionalImpl
                PlayerTextDrawSetProportional = null;

            [Native("PlayerTextDrawSetSelectable")]
            public static readonly PlayerTextDrawSetSelectableImpl
                PlayerTextDrawSetSelectable = null;

            [Native("PlayerTextDrawShow")]
            public static readonly PlayerTextDrawShowImpl PlayerTextDrawShow = null;
            [Native("PlayerTextDrawHide")]
            public static readonly PlayerTextDrawHideImpl PlayerTextDrawHide = null;

            [Native("PlayerTextDrawSetString")]
            public static readonly PlayerTextDrawSetStringImpl
                PlayerTextDrawSetString
                =
                null;

            [Native("PlayerTextDrawSetPreviewModel")]
            public static readonly PlayerTextDrawSetPreviewModelImpl
                PlayerTextDrawSetPreviewModel = null;

            [Native("PlayerTextDrawSetPreviewRot")]
            public static readonly PlayerTextDrawSetPreviewRotImpl
                PlayerTextDrawSetPreviewRot = null;

            [Native("PlayerTextDrawSetPreviewVehCol")]
            public static readonly PlayerTextDrawSetPreviewVehColImpl
