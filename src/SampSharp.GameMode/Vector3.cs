...
public readonly struct Vector3 : IEquatable<Vector3>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="Vector3" /> struct with the z component set to 0.</summary>
    /// <param name="x">Value of the x component.</param>
    /// <param name="y">Value of the y component.</param>
    ...
    /// <param name="x">Value of the x component.</param>
    /// <param name="y">Value of the y component.</param>
    public Vector3(double x, double y) : this((float)x, (float)y)
    {
    }
    ...
    /// <param name="xy">Values of the x and y components.</param>
    /// <param name="z">Value of the z component.</param>
    public Vector3(Vector2 xy, double z) : this(xy.X, xy.Y, (float)z)
    {
    }

    /// <summary>Initializes a new instance of the <see cref="Vector3" /> struct with same values for x, y and z components.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="Vector3" /> struct with same values for x, y and z components.</summary>
    /// <param name="xyz">Value of x, y and z components.</param>
    public Vector3(double xyz) : this((float)xyz, (float)xyz, (float)xyz)
    {
    }

    /// <summary>Gets the X component of this <see cref="Vector3" />.</summary>
    public float X { get; }

    /// <summary>Gets the Y component of this <see cref="Vector3" />.</summary>
    public float Y { get; }

    /// <summary>Gets the Z component of this <see cref="Vector3" />.</summary>
    public float Z { get; }

    /// <summary>Creates a <see cref="Vector2" /> instance with the X and Y components of this <see cref="Vector3" />.</summary>
    public Vector2 XY => new(X, Y);

    /// <summary>Returns an empty <see cref="Vector3" />.</summary>
    public static Vector3 Zero { get; } = new(0);

    /// <summary>Returns a <see cref="Vector3" /> with each component set to 1.</summary>
    ...
    /// <summary>Gets the squared length of this <see cref="Vector3" />.</summary>
    public float LengthSquared => DistanceSquared(this, Zero);

    /// <summary>Gets whether this <see cref="Vector3" /> is empty.</summary>
    public bool IsEmpty => X.Equals(0) && Y.Equals(0) && Z.Equals(0);

    /// <summary>Gets the distance to another <see cref="Vector3" />.</summary>
    ...
    /// <summary>Creates a new <see cref="Vector3" /> instance with the components normalized to a single unit.</summary>
    ...
    /// <summary>
    /// Creates a new <see cref="Vector3" /> that contains the cartesian coordinates of a vector specified in barycentric coordinates and relative to
    /// 3d-triangle.
    /// </summary>
    ...
    public static Vector3 Barycentric(Vector3 value1, Vector3 value2, Vector3 value3, float amount1, float amount2)
    {
        return new Vector3(MathHelper.Barycentric(value1.X, value2.X, value3.X, amount1, amount2),
            MathHelper.Barycentric(value1.Y, value2.Y, value3.Y, amount1, amount2), MathHelper.Barycentric(value1.Z, value2.Z, value3.Z, amount1, amount2));
    }
    ...
    public static Vector3 CatmullRom(Vector3 value1, Vector3 value2, Vector3 value3, Vector3 value4, float amount)
    {
        return new Vector3(MathHelper.CatmullRom(value1.X, value2.X, value3.X, value4.X, amount),
            MathHelper.CatmullRom(value1.Y, value2.Y, value3.Y, value4.Y, amount), MathHelper.CatmullRom(value1.Z, value2.Z, value3.Z, value4.Z, amount));
    }
    ...
    {
        return new Vector3(vector1.Y * vector2.Z - vector2.Y * vector1.Z, -(vector1.X * vector2.Z - vector2.X * vector1.Z),
    ...
    public static Vector3 Hermite(Vector3 value1, Vector3 tangent1, Vector3 value2, Vector3 tangent2, float amount)
    {
        return new Vector3(MathHelper.Hermite(value1.X, tangent1.X, value2.X, tangent2.X, amount),
            MathHelper.Hermite(value1.Y, tangent1.Y, value2.Y, tangent2.Y, amount), MathHelper.Hermite(value1.Z, tangent1.Z, value2.Z, tangent2.Z, amount));
    }
    ...
    public static Vector3 Reflect(Vector3 vector, Vector3 normal)
    {
        ...
        return new Vector3(vector.X - 2.0f * normal.X * dot, vector.Y - 2.0f * normal.Y * dot, vector.Z - 2.0f * normal.Z * dot);
    }
    ...
    {
        return new Vector3(MathHelper.SmoothStep(value1.X, value2.X, amount), MathHelper.SmoothStep(value1.Y, value2.Y, amount),
    ...
    /// <summary>
    /// Creates a new <see cref="Vector3" /> that contains a transformation of 3d-vector by the specified <see cref="Quaternion" />, representing the
    /// rotation.
    /// </summary>
    /// <param name="value">Source <see cref="Vector3" />.</param>
    ...
    public static Vector3 Transform(Vector3 value, Quaternion rotation)
    {
        ...
        return new Vector3(value.X + x * rotation.W + (-rotation.Y * z + rotation.Z * y), value.Y + y * rotation.W + (-rotation.Z * x + rotation.X * z),
    ...
    public static Vector3 TransformNormal(Vector3 normal, Matrix matrix)
    {
        return new Vector3(normal.X * matrix.M11 + normal.Y * matrix.M21 + normal.Z * matrix.M31,
            normal.X * matrix.M12 + normal.Y * matrix.M22 + normal.Z * matrix.M32, normal.X * matrix.M13 + normal.Y * matrix.M23 + normal.Z * matrix.M33);
    }


    /// <summary>Adds the left <see cref="Vector3" />'s components to the right <see cref="Vector3" />'s components and stores it in a new <see cref="Vector3" />.</summary>
    ...
    /// <summary>
    /// Subtracts the right <see cref="Vector3" />'s components from the left <see cref="Vector3" />'s components and stores it in a new
    /// <see cref="Vector3" />.
    /// </summary>
    /// <param name="left">A <see cref="Vector3" />.</param>
    /// <param name="right">A <see cref="Vector3" />.</param>
    ...
    /// <summary>Creates a <see cref="Vector3" /> with the components set to the negative values of the given <paramref name="vector" />'s components.</summary>
    ...
    /// <summary>Multiplies the components <see cref="Vector3" /> by the given scalar and stores them in a new <see cref="Vector3" />.</summary>
    ...
    /// <summary>
    /// Multiplies the components <see cref="Vector3" /> by the components of the right <see cref="Vector3" /> and stores them in a new <see cref="Vector3" />
    /// .
    /// </summary>
    /// <param name="left">A <see cref="Vector3" />.</param>
    /// <param name="right">A <see cref="Vector3" />.</param>
    ...
    /// <summary>Divides the components <see cref="Vector3" /> by the given scalar and stores them in a new <see cref="Vector3" />.</summary>
    /// <param name="vector">The <see cref="Vector3" />.</param>
    /// <param name="scalar">The scalar.</param>
    /// <returns>The new <see cref="Vector3" />.</returns>
    public static Vector3 operator /(Vector3 vector, float scalar)
    ...
    /// <summary>Divides the components <see cref="Vector3" /> by the components of the right <see cref="Vector3" /> and stores them in a new <see cref="Vector3" />.</summary>
    ...
    /// <summary>Tests whether all components of both <see cref="Vector3" /> are equivalent.</summary>
    ...
    /// <summary>Tests whether any component of both <see cref="Vector3" /> are not equivalent.</summary>
    /// <param name="left">Instance of <see cref="Vector3" /> to compare.</param>
    /// <param name="right">Instance of <see cref="Vector3" /> to compare.</param>
