...
/// <summary>
/// Represents a pointer to an <c>robin_hood::unordered_flat_set</c> of open.mp interface pointers of type <typeparamref name="T" />. <c>robin_hood::unordered_flat_set</c> is part of
