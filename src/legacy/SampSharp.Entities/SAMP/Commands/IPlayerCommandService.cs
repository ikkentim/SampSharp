...
/// <summary>Provides the functionality for invoking player commands.</summary>
public interface IPlayerCommandService
{
    /// <summary>Invokes a player command using the specified <paramref name="inputText" /> for the specified <paramref name="player" />.</summary>
