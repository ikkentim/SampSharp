...
/// <summary>Provides extended functionality for configuring a <see cref="GameModeBuilder" /> instance.</summary>
public static class GameModeBuilderExtensions
{
    /// <summary>Enables the EntityComponentSystem with the specified <typeparamref name="TStartup" /> type as the startup configuration.</summary>
