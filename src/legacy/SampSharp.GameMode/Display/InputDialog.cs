...
/// <summary>Represents an input dialog.</summary>
public class InputDialog : Dialog
{
    ...
    public InputDialog(string caption, string message, bool isPassword, string button1, string button2 = null) : base(isPassword
        ? DialogStyle.Password
        : DialogStyle.Input, caption, button1, button2)
    {
