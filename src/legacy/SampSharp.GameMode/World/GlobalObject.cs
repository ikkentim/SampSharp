...
/// <summary>Represents a global object</summary>
public partial class GlobalObject : IdentifiedPool<GlobalObject>, IGameObject
{
    ...
    /// <summary>Gets the rotation of this IGameObject.</summary>
    public virtual Vector3 Rotation
    {
        get
        {
            GlobalObjectInternal.Instance.GetObjectRot(Id, out var x, out var y, out var z);
    ...
    public virtual Vector3 Position
    {
        get
        {
            GlobalObjectInternal.Instance.GetObjectPos(Id, out var x, out var y, out var z);
            return new Vector3(x, y, z);
        }
        set => GlobalObjectInternal.Instance.SetObjectPos(Id, value.X, value.Y, value.Z);
    }

    /// <summary>Gets whether this IGameObject is moving.</summary>
    public virtual bool IsMoving => GlobalObjectInternal.Instance.IsObjectMoving(Id);

    /// <summary>Gets whether this IGameObject is valid.</summary>
    public virtual bool IsValid => GlobalObjectInternal.Instance.IsValidObject(Id);

    /// <summary>Gets the model of this IGameObject.</summary>
    ...
    /// <summary>Gets the draw distance of this IGameObject.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="GlobalObject" /> class.</summary>
    public GlobalObject()
    {
    }
    ...
    public GlobalObject(int modelid, Vector3 position, Vector3 rotation, float drawDistance)
    {
        ...
        Id = GlobalObjectInternal.Instance.CreateObject(modelid, position.X, position.Y, position.Z, rotation.X, rotation.Y, rotation.Z, drawDistance);
    }
    ...
    /// <summary>Moves this IGameObject to the given position and rotation with the given speed.</summary>
    ...
    /// <summary>Moves this IGameObject to the given position with the given speed.</summary>
    /// <param name="position">The position to which to move this IGameObject.</param>
    /// <param name="speed">The speed at which to move this IGameObject.</param>
    /// <returns>The time it will take for the object to move in milliseconds.</returns>
    ...
    /// <summary>Stop this IGameObject from moving any further.</summary>
    public virtual void Stop()
    {
        GlobalObjectInternal.Instance.StopObject(Id);
    }

    /// <summary>Sets the material of this IGameObject.</summary>
    ...
    {
        GlobalObjectInternal.Instance.SetObjectMaterial(Id, materialindex, modelid, txdname, texturename, materialcolor.ToInteger(ColorFormat.ARGB));
    }

    /// <summary>Sets the material text of this IGameObject.</summary>
    /// <param name="materialindex">The material index on the object to change.</param>
    ...
    /// <summary>Toggles the default camera collisions.</summary>
    ...
    /// <summary>Attaches this <see cref="GlobalObject" /> to the specified <paramref name="player" />.</summary>
    ...
    public virtual void AttachTo(BasePlayer player, Vector3 offset, Vector3 rotation)
    {
        ...
        GlobalObjectInternal.Instance.AttachObjectToPlayer(Id, player.Id, offset.X, offset.Y, offset.Z, rotation.X, rotation.Y, rotation.Z);
    }

    /// <summary>Attaches this <see cref="GlobalObject" /> to the specified <paramref name="vehicle" />.</summary>
    ...
    public virtual void AttachTo(BaseVehicle vehicle, Vector3 offset, Vector3 rotation)
    {
        ...
        GlobalObjectInternal.Instance.AttachObjectToVehicle(Id, vehicle.Id, offset.X, offset.Y, offset.Z, rotation.X, rotation.Y, rotation.Z);
    }

    /// <summary>Attaches this <see cref="GlobalObject" /> to the specified <paramref name="globalObject" />.</summary>
    ...
    public virtual void AttachTo(GlobalObject globalObject, Vector3 offset, Vector3 rotation, bool syncRotation = false)
    {
        if (globalObject == null)
            throw new ArgumentNullException(nameof(globalObject));

        GlobalObjectInternal.Instance.AttachObjectToObject(Id, globalObject.Id, offset.X, offset.Y, offset.Z, rotation.X, rotation.Y, rotation.Z, syncRotation);
    }

    /// <summary>Attaches a player's camera to this GlobalObject.</summary>
    ...
    /// <summary>Lets the specified <paramref name="player" /> edit this <see cref="PlayerObject" />.</summary>
    /// <param name="player">The player.</param>
    /// <exception cref="System.ArgumentNullException">player</exception>
