...
/// <summary>Represents a player text label.</summary>
public partial class PlayerTextLabel : IdentifiedOwnedPool<PlayerTextLabel, BasePlayer>
{
    ...
    /// <summary>Gets or sets the color of this <see cref="PlayerTextLabel" />.</summary>
    ...
    /// <summary>Gets or sets the text of this <see cref="PlayerTextLabel" />.</summary>
    ...
    /// <summary>Gets or sets the position of this <see cref="PlayerTextLabel" />.</summary>
    public virtual Vector3 Position
    {
        ...
        set
        {
            _position = value;
            PlayerTextLabelInternal.Instance.DeletePlayer3DTextLabel(Owner.Id, Id);
            Id = PlayerTextLabelInternal.Instance.CreatePlayer3DTextLabel(Owner.Id, Text, Color, Position.X, Position.Y, Position.Z, DrawDistance,
                AttachedPlayer?.Id ?? BasePlayer.InvalidId, AttachedVehicle?.Id ?? BaseVehicle.InvalidId, TestLOS);
        }
    }

    /// <summary>Gets or sets the draw distance.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether to test the line of sight.</summary>
    ...
    /// <summary>Gets or sets the attached player.</summary>
    ...
    /// <summary>Gets or sets the attached vehicle.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="PlayerTextLabel" /> class.</summary>
    ...
    public PlayerTextLabel(BasePlayer owner, string text, Color color, Vector3 position, float drawDistance, bool testLOS)
    {
    ...
    /// <param name="position">The position.</param>
    /// <param name="drawDistance">The draw distance.</param>
    public PlayerTextLabel(BasePlayer owner, string text, Color color, Vector3 position, float drawDistance) : this(owner, text, color, position, drawDistance,
        true)
    {
    }
    ...
    /// <exception cref="System.ArgumentNullException">owner or attachedPlayer</exception>
    public PlayerTextLabel(BasePlayer owner, string text, Color color, Vector3 position, float drawDistance, bool testLOS, BasePlayer attachedPlayer)
    {
        Owner = owner ?? throw new ArgumentNullException(nameof(owner));
        _color = color;
        _position = position;
    ...
    /// <param name="drawDistance">The draw distance.</param>
    /// <param name="attachedPlayer">The attached player.</param>
    public PlayerTextLabel(BasePlayer owner, string text, Color color, Vector3 position, float drawDistance, BasePlayer attachedPlayer) : this(owner, text,
        color, position, drawDistance, true, attachedPlayer)
    {
    }
    ...
    /// <exception cref="System.ArgumentNullException">owner or attachedVehicle</exception>
    ...
    /// <param name="drawDistance">The draw distance.</param>
    /// <param name="attachedVehicle">The attached vehicle.</param>
    public PlayerTextLabel(BasePlayer owner, string text, Color color, Vector3 position, float drawDistance, BaseVehicle attachedVehicle) : this(owner, text,
        color, position, drawDistance, true, attachedVehicle)
    {
    }
}