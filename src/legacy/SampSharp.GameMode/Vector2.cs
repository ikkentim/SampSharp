...
public readonly struct Vector2 : IEquatable<Vector2>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="Vector2" /> struct with same values for x and y components.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="Vector2" /> struct with same values for x and y components.</summary>
    /// <param name="xy">Value of x and y components.</param>
    public Vector2(double xy) : this((float)xy)
    {
    }

    /// <summary>Gets the X component of this <see cref="Vector2" />.</summary>
    public float X { get; }

    /// <summary>Gets the Y component of this <see cref="Vector2" />.</summary>
    public float Y { get; }

    /// <summary>Returns an empty <see cref="Vector2" />.</summary>
    public static Vector2 Zero { get; } = new(0);

    /// <summary>Returns a <see cref="Vector2" /> with each component set to 1.</summary>
    ...
    /// <summary>Gets the squared length of this <see cref="Vector2" />.</summary>
    public float SquaredLength => DistanceSquared(this, Zero);

    /// <summary>Gets whether this <see cref="Vector2" /> is empty.</summary>
    public bool IsEmpty => X.Equals(0.0f) && Y.Equals(0.0f);

    /// <summary>Gets the distance to another <see cref="Vector2" />.</summary>
    ...
    /// <summary>Creates a new <see cref="Vector2" /> instance with the components normalized to a single unit.</summary>
    ...
    /// <summary>
    /// Creates a new <see cref="Vector2" /> that contains the cartesian coordinates of a vector specified in barycentric coordinates and relative to
    /// 2d-triangle.
    /// </summary>
    ...
    /// <summary>Adds the left <see cref="Vector2" />'s components to the right <see cref="Vector2" />'s components and stores it in a new <see cref="Vector2" />.</summary>
    ...
    /// <summary>
    /// Creates a new <see cref="Vector2" /> that contains a transformation of 2d-vector by the specified <see cref="Quaternion" />, representing the
    /// rotation.
    /// </summary>
    /// <param name="value">Source <see cref="Vector2" />.</param>
    ...
    public static Vector2 Transform(Vector2 value, Quaternion rotation)
    {
        ...
        return new Vector2((float)(value.X * (1.0 - rot5.Y - rot5.Z) + value.Y * ((double)rot4.Y - rot4.Z)),
    ...
    /// <summary>
    /// Subtracts the right <see cref="Vector2" />'s components from the left <see cref="Vector2" />'s components and stores it in a new
    /// <see cref="Vector2" />.
    /// </summary>
    /// <param name="left">A <see cref="Vector2" />.</param>
    /// <param name="right">A <see cref="Vector2" />.</param>
    ...
    /// <summary>Creates a <see cref="Vector2" /> with the components set to the negative values of the given <paramref name="vector" />'s components.</summary>
    ...
    /// <summary>Multiplies the components <see cref="Vector2" /> by the given scalar and stores them in a new <see cref="Vector2" />.</summary>
    ...
    /// <summary>
    /// Multiplies the components <see cref="Vector2" /> by the components of the right <see cref="Vector2" /> and stores them in a new <see cref="Vector2" />
    /// .
    /// </summary>
    /// <param name="left">A <see cref="Vector2" />.</param>
    /// <param name="right">A <see cref="Vector2" />.</param>
    ...
    /// <summary>Divides the components <see cref="Vector2" /> by the given scalar and stores them in a new <see cref="Vector2" />.</summary>
    /// <param name="vector">The <see cref="Vector2" />.</param>
    /// <param name="scalar">The scalar.</param>
    /// <returns>The new <see cref="Vector2" />.</returns>
    public static Vector2 operator /(Vector2 vector, float scalar)
    ...
    /// <summary>Divides the components <see cref="Vector2" /> by the components of the right <see cref="Vector2" /> and stores them in a new <see cref="Vector2" />.</summary>
    ...
    /// <summary>Tests whether all components of both <see cref="Vector2" /> are equivalent.</summary>
    ...
    /// <summary>Tests whether any component of both <see cref="Vector2" /> are not equivalent.</summary>
    /// <param name="left">Instance of <see cref="Vector2" /> to compare.</param>
    /// <param name="right">Instance of <see cref="Vector2" /> to compare.</param>
