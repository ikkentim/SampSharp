...
/// <summary>Provides extended functionality for <see cref="GameModeBuilder" /> for configuring the internal SampSharp logger.</summary>
public static class CoreLogGameModeBuilderExtensions
{
    /// <summary>Uses the specified log level as the maximum level which is written to the log by SampSharp.</summary>
    ...
    {
        return builder.AddBuildAction(next =>
        {
    ...
    /// <summary>Uses the specified text writer to log SampSharp log messages to.</summary>
    /// <param name="builder">The game mode builder.</param>
