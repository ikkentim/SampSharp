...
namespace sampgdk {
inline int CreateObject(int modelid = None, float x = None, float y = None, float z = None, float rX = None, float rY = None, float rZ = None, float DrawDistance = 0.0) {
  return sampgdk_CreateObject(modelid, x, y, z, rX, rY, rZ, DrawDistance);
}
inline bool AttachObjectToVehicle(int objectid = None, int vehicleid = None, float fOffsetX = None, float fOffsetY = None, float fOffsetZ = None, float fRotX = None, float fRotY = None, float fRotZ = None) {
  return sampgdk_AttachObjectToVehicle(objectid, vehicleid, fOffsetX, fOffsetY, fOffsetZ, fRotX, fRotY, fRotZ);
}
inline bool AttachObjectToObject(int objectid = None, int attachtoid = None, float fOffsetX = None, float fOffsetY = None, float fOffsetZ = None, float fRotX = None, float fRotY = None, float fRotZ = None, bool SyncRotation = false) {
  return sampgdk_AttachObjectToObject(objectid, attachtoid, fOffsetX, fOffsetY, fOffsetZ, fRotX, fRotY, fRotZ, SyncRotation);
}
inline bool AttachObjectToPlayer(int objectid = None, int playerid = None, float fOffsetX = None, float fOffsetY = None, float fOffsetZ = None, float fRotX = None, float fRotY = None, float fRotZ = None) {
  return sampgdk_AttachObjectToPlayer(objectid, playerid, fOffsetX, fOffsetY, fOffsetZ, fRotX, fRotY, fRotZ);
}
inline bool SetObjectPos(int objectid = None, float x = None, float y = None, float z = None) {
  return sampgdk_SetObjectPos(objectid, x, y, z);
}
inline bool GetObjectPos(int objectid = None, float * x = None, float * y = None, float * z = None) {
  return sampgdk_GetObjectPos(objectid, x, y, z);
}
inline bool SetObjectRot(int objectid = None, float rotX = None, float rotY = None, float rotZ = None) {
  return sampgdk_SetObjectRot(objectid, rotX, rotY, rotZ);
}
inline bool GetObjectRot(int objectid = None, float * rotX = None, float * rotY = None, float * rotZ = None) {
  return sampgdk_GetObjectRot(objectid, rotX, rotY, rotZ);
}
inline bool IsValidObject(int objectid = None) {
  return sampgdk_IsValidObject(objectid);
}
inline bool DestroyObject(int objectid = None) {
  return sampgdk_DestroyObject(objectid);
}
inline int MoveObject(int objectid = None, float X = None, float Y = None, float Z = None, float Speed = None, float RotX = -1000.0, float RotY = -1000.0, float RotZ = -1000.0) {
  return sampgdk_MoveObject(objectid, X, Y, Z, Speed, RotX, RotY, RotZ);
}
inline bool StopObject(int objectid = None) {
  return sampgdk_StopObject(objectid);
}
inline bool IsObjectMoving(int objectid = None) {
  return sampgdk_IsObjectMoving(objectid);
}
inline bool EditObject(int playerid = None, int objectid = None) {
  return sampgdk_EditObject(playerid, objectid);
}
inline bool EditPlayerObject(int playerid = None, int objectid = None) {
  return sampgdk_EditPlayerObject(playerid, objectid);
}
inline bool SelectObject(int playerid = None) {
  return sampgdk_SelectObject(playerid);
}
inline bool CancelEdit(int playerid = None) {
  return sampgdk_CancelEdit(playerid);
}
inline int CreatePlayerObject(int playerid = None, int modelid = None, float x = None, float y = None, float z = None, float rX = None, float rY = None, float rZ = None, float DrawDistance = 0.0) {
  return sampgdk_CreatePlayerObject(playerid, modelid, x, y, z, rX, rY, rZ, DrawDistance);
}
inline bool AttachPlayerObjectToPlayer(int objectplayer = None, int objectid = None, int attachplayer = None, float OffsetX = None, float OffsetY = None, float OffsetZ = None, float rX = None, float rY = None, float rZ = None) {
  return sampgdk_AttachPlayerObjectToPlayer(objectplayer, objectid, attachplayer, OffsetX, OffsetY, OffsetZ, rX, rY, rZ);
}
inline bool AttachPlayerObjectToVehicle(int playerid = None, int objectid = None, int vehicleid = None, float fOffsetX = None, float fOffsetY = None, float fOffsetZ = None, float fRotX = None, float fRotY = None, float RotZ = None) {
  return sampgdk_AttachPlayerObjectToVehicle(playerid, objectid, vehicleid, fOffsetX, fOffsetY, fOffsetZ, fRotX, fRotY, RotZ);
}
inline bool SetPlayerObjectPos(int playerid = None, int objectid = None, float x = None, float y = None, float z = None) {
  return sampgdk_SetPlayerObjectPos(playerid, objectid, x, y, z);
}
inline bool GetPlayerObjectPos(int playerid = None, int objectid = None, float * x = None, float * y = None, float * z = None) {
  return sampgdk_GetPlayerObjectPos(playerid, objectid, x, y, z);
}
inline bool SetPlayerObjectRot(int playerid = None, int objectid = None, float rotX = None, float rotY = None, float rotZ = None) {
  return sampgdk_SetPlayerObjectRot(playerid, objectid, rotX, rotY, rotZ);
}
inline bool GetPlayerObjectRot(int playerid = None, int objectid = None, float * rotX = None, float * rotY = None, float * rotZ = None) {
  return sampgdk_GetPlayerObjectRot(playerid, objectid, rotX, rotY, rotZ);
}
inline bool IsValidPlayerObject(int playerid = None, int objectid = None) {
  return sampgdk_IsValidPlayerObject(playerid, objectid);
}
inline bool DestroyPlayerObject(int playerid = None, int objectid = None) {
  return sampgdk_DestroyPlayerObject(playerid, objectid);
}
inline int MovePlayerObject(int playerid = None, int objectid = None, float x = None, float y = None, float z = None, float Speed = None, float RotX = -1000.0, float RotY = -1000.0, float RotZ = -1000.0) {
  return sampgdk_MovePlayerObject(playerid, objectid, x, y, z, Speed, RotX, RotY, RotZ);
}
inline bool StopPlayerObject(int playerid = None, int objectid = None) {
  return sampgdk_StopPlayerObject(playerid, objectid);
}
inline bool IsPlayerObjectMoving(int playerid = None, int objectid = None) {
  return sampgdk_IsPlayerObjectMoving(playerid, objectid);
}
inline bool SetObjectMaterial(int objectid = None, int materialindex = None, int modelid = None, const char * txdname = None, const char * texturename = None, int materialcolor = 0) {
  return sampgdk_SetObjectMaterial(objectid, materialindex, modelid, txdname, texturename, materialcolor);
}
inline bool SetPlayerObjectMaterial(int playerid = None, int objectid = None, int materialindex = None, int modelid = None, const char * txdname = None, const char * texturename = None, int materialcolor = 0) {
  return sampgdk_SetPlayerObjectMaterial(playerid, objectid, materialindex, modelid, txdname, texturename, materialcolor);
}
inline bool SetObjectMaterialText(int objectid = None, const char * text = None, int materialindex = 0, int materialsize = OBJECT_MATERIAL_SIZE_256x128, const char * fontface = "Arial", int fontsize = 24, bool bold = true, int fontcolor = 0xFFFFFFFF, int backcolor = 0, int textalignment = 0) {
...
inline bool SetPlayerObjectMaterialText(int playerid = None, int objectid = None, const char * text = None, int materialindex = 0, int materialsize = OBJECT_MATERIAL_SIZE_256x128, const char * fontface = "Arial", int fontsize = 24, bool bold = true, int fontcolor = 0xFFFFFFFF, int backcolor = 0, int textalignment = 0) {
...
#ifdef SAMPGDK_CPP_WRAPPERS
namespace sampgdk {
inline bool IsValidVehicle(int vehicleid = None) {
  return sampgdk_IsValidVehicle(vehicleid);
}
inline float GetVehicleDistanceFromPoint(int vehicleid = None, float x = None, float y = None, float z = None) {
  return sampgdk_GetVehicleDistanceFromPoint(vehicleid, x, y, z);
}
inline int CreateVehicle(int vehicletype = None, float x = None, float y = None, float z = None, float rotation = None, int color1 = None, int color2 = None, int respawn_delay = None) {
  return sampgdk_CreateVehicle(vehicletype, x, y, z, rotation, color1, color2, respawn_delay);
}
inline bool DestroyVehicle(int vehicleid = None) {
  return sampgdk_DestroyVehicle(vehicleid);
}
inline bool IsVehicleStreamedIn(int vehicleid = None, int forplayerid = None) {
  return sampgdk_IsVehicleStreamedIn(vehicleid, forplayerid);
}
inline bool GetVehiclePos(int vehicleid = None, float * x = None, float * y = None, float * z = None) {
  return sampgdk_GetVehiclePos(vehicleid, x, y, z);
}
inline bool SetVehiclePos(int vehicleid = None, float x = None, float y = None, float z = None) {
  return sampgdk_SetVehiclePos(vehicleid, x, y, z);
}
inline bool GetVehicleZAngle(int vehicleid = None, float * z_angle = None) {
  return sampgdk_GetVehicleZAngle(vehicleid, z_angle);
}
inline bool GetVehicleRotationQuat(int vehicleid = None, float * w = None, float * x = None, float * y = None, float * z = None) {
  return sampgdk_GetVehicleRotationQuat(vehicleid, w, x, y, z);
}
inline bool SetVehicleZAngle(int vehicleid = None, float z_angle = None) {
  return sampgdk_SetVehicleZAngle(vehicleid, z_angle);
}
inline bool SetVehicleParamsForPlayer(int vehicleid = None, int playerid = None, bool objective = None, bool doorslocked = None) {
...
inline bool SetVehicleParamsEx(int vehicleid = None, bool engine = None, bool lights = None, bool alarm = None, bool doors = None, bool bonnet = None, bool boot = None, bool objective = None) {
  return sampgdk_SetVehicleParamsEx(vehicleid, engine, lights, alarm, doors, bonnet, boot, objective);
}
inline bool GetVehicleParamsEx(int vehicleid = None, bool * engine = None, bool * lights = None, bool * alarm = None, bool * doors = None, bool * bonnet = None, bool * boot = None, bool * objective = None) {
  return sampgdk_GetVehicleParamsEx(vehicleid, engine, lights, alarm, doors, bonnet, boot, objective);
}
inline bool SetVehicleToRespawn(int vehicleid = None) {
  return sampgdk_SetVehicleToRespawn(vehicleid);
}
inline bool LinkVehicleToInterior(int vehicleid = None, int interiorid = None) {
  return sampgdk_LinkVehicleToInterior(vehicleid, interiorid);
}
inline bool AddVehicleComponent(int vehicleid = None, int componentid = None) {
  return sampgdk_AddVehicleComponent(vehicleid, componentid);
}
inline bool RemoveVehicleComponent(int vehicleid = None, int componentid = None) {
  return sampgdk_RemoveVehicleComponent(vehicleid, componentid);
}
inline bool ChangeVehicleColor(int vehicleid = None, int color1 = None, int color2 = None) {
  return sampgdk_ChangeVehicleColor(vehicleid, color1, color2);
}
inline bool ChangeVehiclePaintjob(int vehicleid = None, int paintjobid = None) {
  return sampgdk_ChangeVehiclePaintjob(vehicleid, paintjobid);
}
inline bool SetVehicleHealth(int vehicleid = None, float health = None) {
  return sampgdk_SetVehicleHealth(vehicleid, health);
}
inline bool GetVehicleHealth(int vehicleid = None, float * health = None) {
  return sampgdk_GetVehicleHealth(vehicleid, health);
}
inline bool AttachTrailerToVehicle(int trailerid = None, int vehicleid = None) {
  return sampgdk_AttachTrailerToVehicle(trailerid, vehicleid);
}
inline bool DetachTrailerFromVehicle(int vehicleid = None) {
  return sampgdk_DetachTrailerFromVehicle(vehicleid);
}
inline bool IsTrailerAttachedToVehicle(int vehicleid = None) {
  return sampgdk_IsTrailerAttachedToVehicle(vehicleid);
}
inline int GetVehicleTrailer(int vehicleid = None) {
  return sampgdk_GetVehicleTrailer(vehicleid);
}
inline bool SetVehicleNumberPlate(int vehicleid = None, const char * numberplate = None) {
  return sampgdk_SetVehicleNumberPlate(vehicleid, numberplate);
}
inline int GetVehicleModel(int vehicleid = None) {
  return sampgdk_GetVehicleModel(vehicleid);
}
inline int GetVehicleComponentInSlot(int vehicleid = None, int slot = None) {
  return sampgdk_GetVehicleComponentInSlot(vehicleid, slot);
}
inline int GetVehicleComponentType(int component = None) {
  return sampgdk_GetVehicleComponentType(component);
}
inline bool RepairVehicle(int vehicleid = None) {
  return sampgdk_RepairVehicle(vehicleid);
}
inline bool GetVehicleVelocity(int vehicleid = None, float * X = None, float * Y = None, float * Z = None) {
  return sampgdk_GetVehicleVelocity(vehicleid, X, Y, Z);
}
inline bool SetVehicleVelocity(int vehicleid = None, float X = None, float Y = None, float Z = None) {
  return sampgdk_SetVehicleVelocity(vehicleid, X, Y, Z);
}
inline bool SetVehicleAngularVelocity(int vehicleid = None, float X = None, float Y = None, float Z = None) {
  return sampgdk_SetVehicleAngularVelocity(vehicleid, X, Y, Z);
}
inline bool GetVehicleDamageStatus(int vehicleid = None, int * panels = None, int * doors = None, int * lights = None, int * tires = None) {
  return sampgdk_GetVehicleDamageStatus(vehicleid, panels, doors, lights, tires);
}
inline bool UpdateVehicleDamageStatus(int vehicleid = None, int panels = None, int doors = None, int lights = None, int tires = None) {
  return sampgdk_UpdateVehicleDamageStatus(vehicleid, panels, doors, lights, tires);
}
inline bool SetVehicleVirtualWorld(int vehicleid = None, int worldid = None) {
  return sampgdk_SetVehicleVirtualWorld(vehicleid, worldid);
}
inline int GetVehicleVirtualWorld(int vehicleid = None) {
  return sampgdk_GetVehicleVirtualWorld(vehicleid);
}
inline bool GetVehicleModelInfo(int model = None, int infotype = None, float * X = None, float * Y = None, float * Z = None) {
...
#ifdef SAMPGDK_CPP_WRAPPERS
namespace sampgdk {
inline bool SetSpawnInfo(int playerid = None, int team = None, int skin = None, float x = None, float y = None, float z = None, float rotation = None, int weapon1 = None, int weapon1_ammo = None, int weapon2 = None, int weapon2_ammo = None, int weapon3 = None, int weapon3_ammo = None) {
...
inline bool SpawnPlayer(int playerid = None) {
  return sampgdk_SpawnPlayer(playerid);
}
inline bool SetPlayerPos(int playerid = None, float x = None, float y = None, float z = None) {
  return sampgdk_SetPlayerPos(playerid, x, y, z);
}
inline bool SetPlayerPosFindZ(int playerid = None, float x = None, float y = None, float z = None) {
  return sampgdk_SetPlayerPosFindZ(playerid, x, y, z);
}
inline bool GetPlayerPos(int playerid = None, float * x = None, float * y = None, float * z = None) {
  return sampgdk_GetPlayerPos(playerid, x, y, z);
}
inline bool SetPlayerFacingAngle(int playerid = None, float angle = None) {
  return sampgdk_SetPlayerFacingAngle(playerid, angle);
}
inline bool GetPlayerFacingAngle(int playerid = None, float * angle = None) {
  return sampgdk_GetPlayerFacingAngle(playerid, angle);
}
inline bool IsPlayerInRangeOfPoint(int playerid = None, float range = None, float x = None, float y = None, float z = None) {
  return sampgdk_IsPlayerInRangeOfPoint(playerid, range, x, y, z);
}
inline float GetPlayerDistanceFromPoint(int playerid = None, float x = None, float y = None, float z = None) {
  return sampgdk_GetPlayerDistanceFromPoint(playerid, x, y, z);
}
inline bool IsPlayerStreamedIn(int playerid = None, int forplayerid = None) {
  return sampgdk_IsPlayerStreamedIn(playerid, forplayerid);
}
inline bool SetPlayerInterior(int playerid = None, int interiorid = None) {
  return sampgdk_SetPlayerInterior(playerid, interiorid);
}
inline int GetPlayerInterior(int playerid = None) {
  return sampgdk_GetPlayerInterior(playerid);
}
inline bool SetPlayerHealth(int playerid = None, float health = None) {
  return sampgdk_SetPlayerHealth(playerid, health);
}
inline bool GetPlayerHealth(int playerid = None, float * health = None) {
  return sampgdk_GetPlayerHealth(playerid, health);
}
inline bool SetPlayerArmour(int playerid = None, float armour = None) {
  return sampgdk_SetPlayerArmour(playerid, armour);
}
inline bool GetPlayerArmour(int playerid = None, float * armour = None) {
  return sampgdk_GetPlayerArmour(playerid, armour);
}
inline bool SetPlayerAmmo(int playerid = None, int weaponid = None, int ammo = None) {
  return sampgdk_SetPlayerAmmo(playerid, weaponid, ammo);
}
inline int GetPlayerAmmo(int playerid = None) {
  return sampgdk_GetPlayerAmmo(playerid);
}
inline int GetPlayerWeaponState(int playerid = None) {
  return sampgdk_GetPlayerWeaponState(playerid);
}
inline int GetPlayerTargetPlayer(int playerid = None) {
  return sampgdk_GetPlayerTargetPlayer(playerid);
}
inline bool SetPlayerTeam(int playerid = None, int teamid = None) {
  return sampgdk_SetPlayerTeam(playerid, teamid);
}
inline int GetPlayerTeam(int playerid = None) {
  return sampgdk_GetPlayerTeam(playerid);
}
inline bool SetPlayerScore(int playerid = None, int score = None) {
  return sampgdk_SetPlayerScore(playerid, score);
}
inline int GetPlayerScore(int playerid = None) {
  return sampgdk_GetPlayerScore(playerid);
}
inline int GetPlayerDrunkLevel(int playerid = None) {
  return sampgdk_GetPlayerDrunkLevel(playerid);
}
inline bool SetPlayerDrunkLevel(int playerid = None, int level = None) {
  return sampgdk_SetPlayerDrunkLevel(playerid, level);
}
inline bool SetPlayerColor(int playerid = None, int color = None) {
  return sampgdk_SetPlayerColor(playerid, color);
}
inline int GetPlayerColor(int playerid = None) {
  return sampgdk_GetPlayerColor(playerid);
}
inline bool SetPlayerSkin(int playerid = None, int skinid = None) {
  return sampgdk_SetPlayerSkin(playerid, skinid);
}
inline int GetPlayerSkin(int playerid = None) {
  return sampgdk_GetPlayerSkin(playerid);
}
inline bool GivePlayerWeapon(int playerid = None, int weaponid = None, int ammo = None) {
  return sampgdk_GivePlayerWeapon(playerid, weaponid, ammo);
}
inline bool ResetPlayerWeapons(int playerid = None) {
  return sampgdk_ResetPlayerWeapons(playerid);
}
inline bool SetPlayerArmedWeapon(int playerid = None, int weaponid = None) {
  return sampgdk_SetPlayerArmedWeapon(playerid, weaponid);
}
inline bool GetPlayerWeaponData(int playerid = None, int slot = None, int * weapon = None, int * ammo = None) {
  return sampgdk_GetPlayerWeaponData(playerid, slot, weapon, ammo);
}
inline bool GivePlayerMoney(int playerid = None, int money = None) {
  return sampgdk_GivePlayerMoney(playerid, money);
}
inline bool ResetPlayerMoney(int playerid = None) {
  return sampgdk_ResetPlayerMoney(playerid);
}
inline int SetPlayerName(int playerid = None, const char * name = None) {
  return sampgdk_SetPlayerName(playerid, name);
}
inline int GetPlayerMoney(int playerid = None) {
  return sampgdk_GetPlayerMoney(playerid);
}
inline int GetPlayerState(int playerid = None) {
  return sampgdk_GetPlayerState(playerid);
}
inline bool GetPlayerIp(int playerid = None, char * ip = None, int size = None) {
  return sampgdk_GetPlayerIp(playerid, ip, size);
}
inline int GetPlayerPing(int playerid = None) {
  return sampgdk_GetPlayerPing(playerid);
}
inline int GetPlayerWeapon(int playerid = None) {
  return sampgdk_GetPlayerWeapon(playerid);
}
inline bool GetPlayerKeys(int playerid = None, int * keys = None, int * updown = None, int * leftright = None) {
  return sampgdk_GetPlayerKeys(playerid, keys, updown, leftright);
}
inline int GetPlayerName(int playerid = None, char * name = None, int size = None) {
  return sampgdk_GetPlayerName(playerid, name, size);
}
inline bool SetPlayerTime(int playerid = None, int hour = None, int minute = None) {
  return sampgdk_SetPlayerTime(playerid, hour, minute);
}
inline bool GetPlayerTime(int playerid = None, int * hour = None, int * minute = None) {
  return sampgdk_GetPlayerTime(playerid, hour, minute);
}
inline bool TogglePlayerClock(int playerid = None, bool toggle = None) {
  return sampgdk_TogglePlayerClock(playerid, toggle);
}
inline bool SetPlayerWeather(int playerid = None, int weather = None) {
  return sampgdk_SetPlayerWeather(playerid, weather);
}
inline bool ForceClassSelection(int playerid = None) {
  return sampgdk_ForceClassSelection(playerid);
}
inline bool SetPlayerWantedLevel(int playerid = None, int level = None) {
  return sampgdk_SetPlayerWantedLevel(playerid, level);
}
inline int GetPlayerWantedLevel(int playerid = None) {
  return sampgdk_GetPlayerWantedLevel(playerid);
}
inline bool SetPlayerFightingStyle(int playerid = None, int style = None) {
  return sampgdk_SetPlayerFightingStyle(playerid, style);
}
inline int GetPlayerFightingStyle(int playerid = None) {
  return sampgdk_GetPlayerFightingStyle(playerid);
}
inline bool SetPlayerVelocity(int playerid = None, float x = None, float y = None, float z = None) {
  return sampgdk_SetPlayerVelocity(playerid, x, y, z);
}
inline bool GetPlayerVelocity(int playerid = None, float * x = None, float * y = None, float * z = None) {
  return sampgdk_GetPlayerVelocity(playerid, x, y, z);
}
inline bool PlayCrimeReportForPlayer(int playerid = None, int suspectid = None, int crime = None) {
  return sampgdk_PlayCrimeReportForPlayer(playerid, suspectid, crime);
}
inline bool PlayAudioStreamForPlayer(int playerid = None, const char * url = None, float posX = 0.0, float posY = 0.0, float posZ = 0.0, float distance = 50.0, bool usepos = false) {
  return sampgdk_PlayAudioStreamForPlayer(playerid, url, posX, posY, posZ, distance, usepos);
}
inline bool StopAudioStreamForPlayer(int playerid = None) {
  return sampgdk_StopAudioStreamForPlayer(playerid);
}
inline bool SetPlayerShopName(int playerid = None, const char * shopname = None) {
  return sampgdk_SetPlayerShopName(playerid, shopname);
}
inline bool SetPlayerSkillLevel(int playerid = None, int skill = None, int level = None) {
  return sampgdk_SetPlayerSkillLevel(playerid, skill, level);
}
inline int GetPlayerSurfingVehicleID(int playerid = None) {
  return sampgdk_GetPlayerSurfingVehicleID(playerid);
}
inline int GetPlayerSurfingObjectID(int playerid = None) {
  return sampgdk_GetPlayerSurfingObjectID(playerid);
}
inline bool RemoveBuildingForPlayer(int playerid = None, int modelid = None, float fX = None, float fY = None, float fZ = None, float fRadius = None) {
  return sampgdk_RemoveBuildingForPlayer(playerid, modelid, fX, fY, fZ, fRadius);
}
inline bool GetPlayerLastShotVectors(int playerid = None, float * fOriginX = None, float * fOriginY = None, float * fOriginZ = None, float * fHitPosX = None, float * fHitPosY = None, float * fHitPosZ = None) {
  return sampgdk_GetPlayerLastShotVectors(playerid, fOriginX, fOriginY, fOriginZ, fHitPosX, fHitPosY, fHitPosZ);
}
inline bool SetPlayerAttachedObject(int playerid = None, int index = None, int modelid = None, int bone = None, float fOffsetX = 0.0, float fOffsetY = 0.0, float fOffsetZ = 0.0, float fRotX = 0.0, float fRotY = 0.0, float fRotZ = 0.0, float fScaleX = 1.0, float fScaleY = 1.0, float fScaleZ = 1.0, int materialcolor1 = 0, int materialcolor2 = 0) {
...
inline bool RemovePlayerAttachedObject(int playerid = None, int index = None) {
  return sampgdk_RemovePlayerAttachedObject(playerid, index);
}
inline bool IsPlayerAttachedObjectSlotUsed(int playerid = None, int index = None) {
  return sampgdk_IsPlayerAttachedObjectSlotUsed(playerid, index);
}
inline bool EditAttachedObject(int playerid = None, int index = None) {
  return sampgdk_EditAttachedObject(playerid, index);
}
inline int CreatePlayerTextDraw(int playerid = None, float x = None, float y = None, const char * text = None) {
  return sampgdk_CreatePlayerTextDraw(playerid, x, y, text);
}
inline bool PlayerTextDrawDestroy(int playerid = None, int text = None) {
  return sampgdk_PlayerTextDrawDestroy(playerid, text);
}
inline bool PlayerTextDrawLetterSize(int playerid = None, int text = None, float x = None, float y = None) {
  return sampgdk_PlayerTextDrawLetterSize(playerid, text, x, y);
}
inline bool PlayerTextDrawTextSize(int playerid = None, int text = None, float x = None, float y = None) {
  return sampgdk_PlayerTextDrawTextSize(playerid, text, x, y);
}
inline bool PlayerTextDrawAlignment(int playerid = None, int text = None, int alignment = None) {
  return sampgdk_PlayerTextDrawAlignment(playerid, text, alignment);
}
inline bool PlayerTextDrawColor(int playerid = None, int text = None, int color = None) {
  return sampgdk_PlayerTextDrawColor(playerid, text, color);
}
inline bool PlayerTextDrawUseBox(int playerid = None, int text = None, bool use = None) {
  return sampgdk_PlayerTextDrawUseBox(playerid, text, use);
}
inline bool PlayerTextDrawBoxColor(int playerid = None, int text = None, int color = None) {
  return sampgdk_PlayerTextDrawBoxColor(playerid, text, color);
}
inline bool PlayerTextDrawSetShadow(int playerid = None, int text = None, int size = None) {
  return sampgdk_PlayerTextDrawSetShadow(playerid, text, size);
}
inline bool PlayerTextDrawSetOutline(int playerid = None, int text = None, int size = None) {
  return sampgdk_PlayerTextDrawSetOutline(playerid, text, size);
}
inline bool PlayerTextDrawBackgroundColor(int playerid = None, int text = None, int color = None) {
  return sampgdk_PlayerTextDrawBackgroundColor(playerid, text, color);
}
inline bool PlayerTextDrawFont(int playerid = None, int text = None, int font = None) {
  return sampgdk_PlayerTextDrawFont(playerid, text, font);
}
inline bool PlayerTextDrawSetProportional(int playerid = None, int text = None, bool set = None) {
  return sampgdk_PlayerTextDrawSetProportional(playerid, text, set);
}
inline bool PlayerTextDrawSetSelectable(int playerid = None, int text = None, bool set = None) {
  return sampgdk_PlayerTextDrawSetSelectable(playerid, text, set);
}
inline bool PlayerTextDrawShow(int playerid = None, int text = None) {
  return sampgdk_PlayerTextDrawShow(playerid, text);
}
inline bool PlayerTextDrawHide(int playerid = None, int text = None) {
  return sampgdk_PlayerTextDrawHide(playerid, text);
}
inline bool PlayerTextDrawSetString(int playerid = None, int text = None, const char * string = None) {
  return sampgdk_PlayerTextDrawSetString(playerid, text, string);
}
inline bool PlayerTextDrawSetPreviewModel(int playerid = None, int text = None, int modelindex = None) {
  return sampgdk_PlayerTextDrawSetPreviewModel(playerid, text, modelindex);
}
inline bool PlayerTextDrawSetPreviewRot(int playerid = None, int text = None, float fRotX = None, float fRotY = None, float fRotZ = None, float fZoom = 1.0) {
  return sampgdk_PlayerTextDrawSetPreviewRot(playerid, text, fRotX, fRotY, fRotZ, fZoom);
}
inline bool PlayerTextDrawSetPreviewVehCol(int playerid = None, int text = None, int color1 = None, int color2 = None) {
  return sampgdk_PlayerTextDrawSetPreviewVehCol(playerid, text, color1, color2);
}
inline bool SetPVarInt(int playerid = None, const char * varname = None, int value = None) {
  return sampgdk_SetPVarInt(playerid, varname, value);
}
inline int GetPVarInt(int playerid = None, const char * varname = None) {
  return sampgdk_GetPVarInt(playerid, varname);
}
inline bool SetPVarString(int playerid = None, const char * varname = None, const char * value = None) {
  return sampgdk_SetPVarString(playerid, varname, value);
}
inline bool GetPVarString(int playerid = None, const char * varname = None, char * value = None, int size = None) {
  return sampgdk_GetPVarString(playerid, varname, value, size);
}
inline bool SetPVarFloat(int playerid = None, const char * varname = None, float value = None) {
  return sampgdk_SetPVarFloat(playerid, varname, value);
}
inline float GetPVarFloat(int playerid = None, const char * varname = None) {
  return sampgdk_GetPVarFloat(playerid, varname);
}
inline bool DeletePVar(int playerid = None, const char * varname = None) {
  return sampgdk_DeletePVar(playerid, varname);
}
inline int GetPVarsUpperIndex(int playerid = None) {
  return sampgdk_GetPVarsUpperIndex(playerid);
}
inline bool GetPVarNameAtIndex(int playerid = None, int index = None, char * varname = None, int size = None) {
  return sampgdk_GetPVarNameAtIndex(playerid, index, varname, size);
}
inline int GetPVarType(int playerid = None, const char * varname = None) {
  return sampgdk_GetPVarType(playerid, varname);
}
inline bool SetPlayerChatBubble(int playerid = None, const char * text = None, int color = None, float drawdistance = None, int expiretime = None) {
  return sampgdk_SetPlayerChatBubble(playerid, text, color, drawdistance, expiretime);
}
inline bool PutPlayerInVehicle(int playerid = None, int vehicleid = None, int seatid = None) {
  return sampgdk_PutPlayerInVehicle(playerid, vehicleid, seatid);
}
inline int GetPlayerVehicleID(int playerid = None) {
  return sampgdk_GetPlayerVehicleID(playerid);
}
inline int GetPlayerVehicleSeat(int playerid = None) {
  return sampgdk_GetPlayerVehicleSeat(playerid);
}
inline bool RemovePlayerFromVehicle(int playerid = None) {
  return sampgdk_RemovePlayerFromVehicle(playerid);
}
inline bool TogglePlayerControllable(int playerid = None, bool toggle = None) {
  return sampgdk_TogglePlayerControllable(playerid, toggle);
}
inline bool PlayerPlaySound(int playerid = None, int soundid = None, float x = None, float y = None, float z = None) {
  return sampgdk_PlayerPlaySound(playerid, soundid, x, y, z);
}
inline bool ApplyAnimation(int playerid = None, const char * animlib = None, const char * animname = None, float fDelta = None, bool loop = None, bool lockx = None, bool locky = None, bool freeze = None, int time = None, bool forcesync = false) {
  return sampgdk_ApplyAnimation(playerid, animlib, animname, fDelta, loop, lockx, locky, freeze, time, forcesync);
}
inline bool ClearAnimations(int playerid = None, bool forcesync = false) {
  return sampgdk_ClearAnimations(playerid, forcesync);
}
inline int GetPlayerAnimationIndex(int playerid = None) {
  return sampgdk_GetPlayerAnimationIndex(playerid);
}
inline bool GetAnimationName(int index = None, char * animlib = None, int animlib_size = None, char * animname = None, int animname_size = None) {
  return sampgdk_GetAnimationName(index, animlib, animlib_size, animname, animname_size);
}
inline int GetPlayerSpecialAction(int playerid = None) {
  return sampgdk_GetPlayerSpecialAction(playerid);
}
inline bool SetPlayerSpecialAction(int playerid = None, int actionid = None) {
  return sampgdk_SetPlayerSpecialAction(playerid, actionid);
}
inline bool SetPlayerCheckpoint(int playerid = None, float x = None, float y = None, float z = None, float size = None) {
  return sampgdk_SetPlayerCheckpoint(playerid, x, y, z, size);
}
inline bool DisablePlayerCheckpoint(int playerid = None) {
  return sampgdk_DisablePlayerCheckpoint(playerid);
}
inline bool SetPlayerRaceCheckpoint(int playerid = None, int type = None, float x = None, float y = None, float z = None, float nextx = None, float nexty = None, float nextz = None, float size = None) {
  return sampgdk_SetPlayerRaceCheckpoint(playerid, type, x, y, z, nextx, nexty, nextz, size);
}
inline bool DisablePlayerRaceCheckpoint(int playerid = None) {
  return sampgdk_DisablePlayerRaceCheckpoint(playerid);
}
inline bool SetPlayerWorldBounds(int playerid = None, float x_max = None, float x_min = None, float y_max = None, float y_min = None) {
  return sampgdk_SetPlayerWorldBounds(playerid, x_max, x_min, y_max, y_min);
}
inline bool SetPlayerMarkerForPlayer(int playerid = None, int showplayerid = None, int color = None) {
  return sampgdk_SetPlayerMarkerForPlayer(playerid, showplayerid, color);
}
inline bool ShowPlayerNameTagForPlayer(int playerid = None, int showplayerid = None, bool show = None) {
  return sampgdk_ShowPlayerNameTagForPlayer(playerid, showplayerid, show);
}
inline bool SetPlayerMapIcon(int playerid = None, int iconid = None, float x = None, float y = None, float z = None, int markertype = None, int color = None, int style = MAPICON_LOCAL) {
  return sampgdk_SetPlayerMapIcon(playerid, iconid, x, y, z, markertype, color, style);
}
inline bool RemovePlayerMapIcon(int playerid = None, int iconid = None) {
  return sampgdk_RemovePlayerMapIcon(playerid, iconid);
}
inline bool AllowPlayerTeleport(int playerid = None, bool allow = None) {
  return sampgdk_AllowPlayerTeleport(playerid, allow);
}
inline bool SetPlayerCameraPos(int playerid = None, float x = None, float y = None, float z = None) {
  return sampgdk_SetPlayerCameraPos(playerid, x, y, z);
}
inline bool SetPlayerCameraLookAt(int playerid = None, float x = None, float y = None, float z = None, int cut = CAMERA_CUT) {
  return sampgdk_SetPlayerCameraLookAt(playerid, x, y, z, cut);
}
inline bool SetCameraBehindPlayer(int playerid = None) {
  return sampgdk_SetCameraBehindPlayer(playerid);
}
inline bool GetPlayerCameraPos(int playerid = None, float * x = None, float * y = None, float * z = None) {
  return sampgdk_GetPlayerCameraPos(playerid, x, y, z);
}
inline bool GetPlayerCameraFrontVector(int playerid = None, float * x = None, float * y = None, float * z = None) {
  return sampgdk_GetPlayerCameraFrontVector(playerid, x, y, z);
}
inline int GetPlayerCameraMode(int playerid = None) {
  return sampgdk_GetPlayerCameraMode(playerid);
}
inline float GetPlayerCameraAspectRatio(int playerid = None) {
  return sampgdk_GetPlayerCameraAspectRatio(playerid);
}
inline float GetPlayerCameraZoom(int playerid = None) {
  return sampgdk_GetPlayerCameraZoom(playerid);
}
inline bool AttachCameraToObject(int playerid = None, int objectid = None) {
  return sampgdk_AttachCameraToObject(playerid, objectid);
}
inline bool AttachCameraToPlayerObject(int playerid = None, int playerobjectid = None) {
  return sampgdk_AttachCameraToPlayerObject(playerid, playerobjectid);
}
inline bool InterpolateCameraPos(int playerid = None, float FromX = None, float FromY = None, float FromZ = None, float ToX = None, float ToY = None, float ToZ = None, int time = None, int cut = CAMERA_CUT) {
  return sampgdk_InterpolateCameraPos(playerid, FromX, FromY, FromZ, ToX, ToY, ToZ, time, cut);
}
inline bool InterpolateCameraLookAt(int playerid = None, float FromX = None, float FromY = None, float FromZ = None, float ToX = None, float ToY = None, float ToZ = None, int time = None, int cut = CAMERA_CUT) {
  return sampgdk_InterpolateCameraLookAt(playerid, FromX, FromY, FromZ, ToX, ToY, ToZ, time, cut);
}
inline bool IsPlayerConnected(int playerid = None) {
  return sampgdk_IsPlayerConnected(playerid);
}
inline bool IsPlayerInVehicle(int playerid = None, int vehicleid = None) {
  return sampgdk_IsPlayerInVehicle(playerid, vehicleid);
}
inline bool IsPlayerInAnyVehicle(int playerid = None) {
  return sampgdk_IsPlayerInAnyVehicle(playerid);
}
inline bool IsPlayerInCheckpoint(int playerid = None) {
  return sampgdk_IsPlayerInCheckpoint(playerid);
}
inline bool IsPlayerInRaceCheckpoint(int playerid = None) {
  return sampgdk_IsPlayerInRaceCheckpoint(playerid);
}
inline bool SetPlayerVirtualWorld(int playerid = None, int worldid = None) {
  return sampgdk_SetPlayerVirtualWorld(playerid, worldid);
}
inline int GetPlayerVirtualWorld(int playerid = None) {
  return sampgdk_GetPlayerVirtualWorld(playerid);
}
inline bool EnableStuntBonusForPlayer(int playerid = None, bool enable = None) {
  return sampgdk_EnableStuntBonusForPlayer(playerid, enable);
}
inline bool EnableStuntBonusForAll(bool enable = None) {
  return sampgdk_EnableStuntBonusForAll(enable);
}
inline bool TogglePlayerSpectating(int playerid = None, bool toggle = None) {
  return sampgdk_TogglePlayerSpectating(playerid, toggle);
}
inline bool PlayerSpectatePlayer(int playerid = None, int targetplayerid = None, int mode = SPECTATE_MODE_NORMAL) {
  return sampgdk_PlayerSpectatePlayer(playerid, targetplayerid, mode);
}
inline bool PlayerSpectateVehicle(int playerid = None, int targetvehicleid = None, int mode = SPECTATE_MODE_NORMAL) {
  return sampgdk_PlayerSpectateVehicle(playerid, targetvehicleid, mode);
}
inline bool StartRecordingPlayerData(int playerid = None, int recordtype = None, const char * recordname = None) {
  return sampgdk_StartRecordingPlayerData(playerid, recordtype, recordname);
}
inline bool StopRecordingPlayerData(int playerid = None) {
  return sampgdk_StopRecordingPlayerData(playerid);
}
inline bool CreateExplosionForPlayer(int playerid = None, float X = None, float Y = None, float Z = None, int type = None, float Radius = None) {
...
#ifdef SAMPGDK_CPP_WRAPPERS
namespace sampgdk {
inline bool SendClientMessage(int playerid = None, int color = None, const char * message = None) {
  return sampgdk_SendClientMessage(playerid, color, message);
}
inline bool SendClientMessageToAll(int color = None, const char * message = None) {
  return sampgdk_SendClientMessageToAll(color, message);
}
inline bool SendPlayerMessageToPlayer(int playerid = None, int senderid = None, const char * message = None) {
  return sampgdk_SendPlayerMessageToPlayer(playerid, senderid, message);
}
inline bool SendPlayerMessageToAll(int senderid = None, const char * message = None) {
  return sampgdk_SendPlayerMessageToAll(senderid, message);
}
inline bool SendDeathMessage(int killer = None, int killee = None, int weapon = None) {
  return sampgdk_SendDeathMessage(killer, killee, weapon);
}
inline bool SendDeathMessageToPlayer(int playerid = None, int killer = None, int killee = None, int weapon = None) {
  return sampgdk_SendDeathMessageToPlayer(playerid, killer, killee, weapon);
}
inline bool GameTextForAll(const char * text = None, int time = None, int style = None) {
  return sampgdk_GameTextForAll(text, time, style);
}
inline bool GameTextForPlayer(int playerid = None, const char * text = None, int time = None, int style = None) {
...
inline float VectorSize(float x = None, float y = None, float z = None) {
  return sampgdk_VectorSize(x, y, z);
}
inline bool SetGameModeText(const char * text = None) {
  return sampgdk_SetGameModeText(text);
}
inline bool SetTeamCount(int count = None) {
  return sampgdk_SetTeamCount(count);
}
inline int AddPlayerClass(int modelid = None, float spawn_x = None, float spawn_y = None, float spawn_z = None, float z_angle = None, int weapon1 = None, int weapon1_ammo = None, int weapon2 = None, int weapon2_ammo = None, int weapon3 = None, int weapon3_ammo = None) {
...
inline int AddPlayerClassEx(int teamid = None, int modelid = None, float spawn_x = None, float spawn_y = None, float spawn_z = None, float z_angle = None, int weapon1 = None, int weapon1_ammo = None, int weapon2 = None, int weapon2_ammo = None, int weapon3 = None, int weapon3_ammo = None) {
...
inline int AddStaticVehicle(int modelid = None, float spawn_x = None, float spawn_y = None, float spawn_z = None, float z_angle = None, int color1 = None, int color2 = None) {
  return sampgdk_AddStaticVehicle(modelid, spawn_x, spawn_y, spawn_z, z_angle, color1, color2);
}
inline int AddStaticVehicleEx(int modelid = None, float spawn_x = None, float spawn_y = None, float spawn_z = None, float z_angle = None, int color1 = None, int color2 = None, int respawn_delay = None) {
  return sampgdk_AddStaticVehicleEx(modelid, spawn_x, spawn_y, spawn_z, z_angle, color1, color2, respawn_delay);
}
inline int AddStaticPickup(int model = None, int type = None, float x = None, float y = None, float z = None, int virtualworld = 0) {
  return sampgdk_AddStaticPickup(model, type, x, y, z, virtualworld);
}
inline int CreatePickup(int model = None, int type = None, float x = None, float y = None, float z = None, int virtualworld = 0) {
  return sampgdk_CreatePickup(model, type, x, y, z, virtualworld);
}
inline bool DestroyPickup(int pickup = None) {
  return sampgdk_DestroyPickup(pickup);
}
inline bool ShowNameTags(bool show = None) {
  return sampgdk_ShowNameTags(show);
}
inline bool ShowPlayerMarkers(int mode = None) {
  return sampgdk_ShowPlayerMarkers(mode);
}
inline bool GameModeExit() {
  return sampgdk_GameModeExit();
}
inline bool SetWorldTime(int hour = None) {
  return sampgdk_SetWorldTime(hour);
}
inline bool GetWeaponName(int weaponid = None, char * name = None, int size = None) {
  return sampgdk_GetWeaponName(weaponid, name, size);
}
inline bool EnableTirePopping(bool enable = None) {
  return sampgdk_EnableTirePopping(enable);
}
inline bool EnableVehicleFriendlyFire() {
  return sampgdk_EnableVehicleFriendlyFire();
}
inline bool AllowInteriorWeapons(bool allow = None) {
  return sampgdk_AllowInteriorWeapons(allow);
}
inline bool SetWeather(int weatherid = None) {
  return sampgdk_SetWeather(weatherid);
}
inline bool SetGravity(float gravity = None) {
  return sampgdk_SetGravity(gravity);
}
inline bool AllowAdminTeleport(bool allow = None) {
  return sampgdk_AllowAdminTeleport(allow);
}
inline bool SetDeathDropAmount(int amount = None) {
  return sampgdk_SetDeathDropAmount(amount);
}
inline bool CreateExplosion(float x = None, float y = None, float z = None, int type = None, float radius = None) {
  return sampgdk_CreateExplosion(x, y, z, type, radius);
}
inline bool EnableZoneNames(bool enable = None) {
...
inline bool SetNameTagDrawDistance(float distance = None) {
  return sampgdk_SetNameTagDrawDistance(distance);
}
inline bool DisableNameTagLOS() {
  return sampgdk_DisableNameTagLOS();
}
inline bool LimitGlobalChatRadius(float chat_radius = None) {
  return sampgdk_LimitGlobalChatRadius(chat_radius);
}
inline bool LimitPlayerMarkerRadius(float marker_radius = None) {
  return sampgdk_LimitPlayerMarkerRadius(marker_radius);
}
inline bool ConnectNPC(const char * name = None, const char * script = None) {
  return sampgdk_ConnectNPC(name, script);
}
inline bool IsPlayerNPC(int playerid = None) {
  return sampgdk_IsPlayerNPC(playerid);
}
inline bool IsPlayerAdmin(int playerid = None) {
  return sampgdk_IsPlayerAdmin(playerid);
}
inline bool Kick(int playerid = None) {
  return sampgdk_Kick(playerid);
}
inline bool Ban(int playerid = None) {
  return sampgdk_Ban(playerid);
}
inline bool BanEx(int playerid = None, const char * reason = None) {
  return sampgdk_BanEx(playerid, reason);
}
inline bool SendRconCommand(const char * command = None) {
  return sampgdk_SendRconCommand(command);
}
inline bool GetServerVarAsString(const char * varname = None, char * value = None, int size = None) {
  return sampgdk_GetServerVarAsString(varname, value, size);
}
inline int GetServerVarAsInt(const char * varname = None) {
  return sampgdk_GetServerVarAsInt(varname);
}
inline bool GetServerVarAsBool(const char * varname = None) {
  return sampgdk_GetServerVarAsBool(varname);
}
inline bool GetPlayerNetworkStats(int playerid = None, char * retstr = None, int size = None) {
  return sampgdk_GetPlayerNetworkStats(playerid, retstr, size);
}
inline bool GetNetworkStats(char * retstr = None, int size = None) {
  return sampgdk_GetNetworkStats(retstr, size);
}
inline bool GetPlayerVersion(int playerid = None, char * version = None, int len = None) {
  return sampgdk_GetPlayerVersion(playerid, version, len);
}
inline bool BlockIpAddress(const char * ip_address = None, int timems = None) {
  return sampgdk_BlockIpAddress(ip_address, timems);
}
inline bool UnBlockIpAddress(const char * ip_address = None) {
  return sampgdk_UnBlockIpAddress(ip_address);
}
inline int GetServerTickRate() {
  return sampgdk_GetServerTickRate();
}
inline int NetStats_GetConnectedTime(int playerid = None) {
  return sampgdk_NetStats_GetConnectedTime(playerid);
}
inline int NetStats_MessagesReceived(int playerid = None) {
  return sampgdk_NetStats_MessagesReceived(playerid);
}
inline int NetStats_BytesReceived(int playerid = None) {
  return sampgdk_NetStats_BytesReceived(playerid);
}
inline int NetStats_MessagesSent(int playerid = None) {
  return sampgdk_NetStats_MessagesSent(playerid);
}
inline int NetStats_BytesSent(int playerid = None) {
  return sampgdk_NetStats_BytesSent(playerid);
}
inline int NetStats_MessagesRecvPerSecond(int playerid = None) {
  return sampgdk_NetStats_MessagesRecvPerSecond(playerid);
}
inline float NetStats_PacketLossPercent(int playerid = None) {
  return sampgdk_NetStats_PacketLossPercent(playerid);
}
inline int NetStats_ConnectionStatus(int playerid = None) {
  return sampgdk_NetStats_ConnectionStatus(playerid);
}
inline bool NetStats_GetIpPort(int playerid = None, char * ip_port = None, int ip_port_len = None) {
  return sampgdk_NetStats_GetIpPort(playerid, ip_port, ip_port_len);
}
inline int CreateMenu(const char * title = None, int columns = None, float x = None, float y = None, float col1width = None, float col2width = 0.0) {
  return sampgdk_CreateMenu(title, columns, x, y, col1width, col2width);
}
inline bool DestroyMenu(int menuid = None) {
  return sampgdk_DestroyMenu(menuid);
}
inline int AddMenuItem(int menuid = None, int column = None, const char * menutext = None) {
  return sampgdk_AddMenuItem(menuid, column, menutext);
}
inline bool SetMenuColumnHeader(int menuid = None, int column = None, const char * columnheader = None) {
  return sampgdk_SetMenuColumnHeader(menuid, column, columnheader);
}
inline bool ShowMenuForPlayer(int menuid = None, int playerid = None) {
  return sampgdk_ShowMenuForPlayer(menuid, playerid);
}
inline bool HideMenuForPlayer(int menuid = None, int playerid = None) {
  return sampgdk_HideMenuForPlayer(menuid, playerid);
}
inline bool IsValidMenu(int menuid = None) {
  return sampgdk_IsValidMenu(menuid);
}
inline bool DisableMenu(int menuid = None) {
  return sampgdk_DisableMenu(menuid);
}
inline bool DisableMenuRow(int menuid = None, int row = None) {
  return sampgdk_DisableMenuRow(menuid, row);
}
inline int GetPlayerMenu(int playerid = None) {
  return sampgdk_GetPlayerMenu(playerid);
}
inline int TextDrawCreate(float x = None, float y = None, const char * text = None) {
  return sampgdk_TextDrawCreate(x, y, text);
}
inline bool TextDrawDestroy(int text = None) {
  return sampgdk_TextDrawDestroy(text);
}
inline bool TextDrawLetterSize(int text = None, float x = None, float y = None) {
  return sampgdk_TextDrawLetterSize(text, x, y);
}
inline bool TextDrawTextSize(int text = None, float x = None, float y = None) {
  return sampgdk_TextDrawTextSize(text, x, y);
}
inline bool TextDrawAlignment(int text = None, int alignment = None) {
  return sampgdk_TextDrawAlignment(text, alignment);
}
inline bool TextDrawColor(int text = None, int color = None) {
  return sampgdk_TextDrawColor(text, color);
}
inline bool TextDrawUseBox(int text = None, bool use = None) {
  return sampgdk_TextDrawUseBox(text, use);
}
inline bool TextDrawBoxColor(int text = None, int color = None) {
  return sampgdk_TextDrawBoxColor(text, color);
}
inline bool TextDrawSetShadow(int text = None, int size = None) {
  return sampgdk_TextDrawSetShadow(text, size);
}
inline bool TextDrawSetOutline(int text = None, int size = None) {
  return sampgdk_TextDrawSetOutline(text, size);
}
inline bool TextDrawBackgroundColor(int text = None, int color = None) {
  return sampgdk_TextDrawBackgroundColor(text, color);
}
inline bool TextDrawFont(int text = None, int font = None) {
  return sampgdk_TextDrawFont(text, font);
}
inline bool TextDrawSetProportional(int text = None, bool set = None) {
  return sampgdk_TextDrawSetProportional(text, set);
}
inline bool TextDrawSetSelectable(int text = None, bool set = None) {
  return sampgdk_TextDrawSetSelectable(text, set);
}
inline bool TextDrawShowForPlayer(int playerid = None, int text = None) {
  return sampgdk_TextDrawShowForPlayer(playerid, text);
}
inline bool TextDrawHideForPlayer(int playerid = None, int text = None) {
  return sampgdk_TextDrawHideForPlayer(playerid, text);
}
inline bool TextDrawShowForAll(int text = None) {
  return sampgdk_TextDrawShowForAll(text);
}
inline bool TextDrawHideForAll(int text = None) {
  return sampgdk_TextDrawHideForAll(text);
}
inline bool TextDrawSetString(int text = None, const char * string = None) {
  return sampgdk_TextDrawSetString(text, string);
}
inline bool TextDrawSetPreviewModel(int text = None, int modelindex = None) {
  return sampgdk_TextDrawSetPreviewModel(text, modelindex);
}
inline bool TextDrawSetPreviewRot(int text = None, float fRotX = None, float fRotY = None, float fRotZ = None, float fZoom = 1.0) {
  return sampgdk_TextDrawSetPreviewRot(text, fRotX, fRotY, fRotZ, fZoom);
}
inline bool TextDrawSetPreviewVehCol(int text = None, int color1 = None, int color2 = None) {
  return sampgdk_TextDrawSetPreviewVehCol(text, color1, color2);
}
inline bool SelectTextDraw(int playerid = None, int hovercolor = None) {
  return sampgdk_SelectTextDraw(playerid, hovercolor);
}
inline bool CancelSelectTextDraw(int playerid = None) {
  return sampgdk_CancelSelectTextDraw(playerid);
}
inline int GangZoneCreate(float minx = None, float miny = None, float maxx = None, float maxy = None) {
  return sampgdk_GangZoneCreate(minx, miny, maxx, maxy);
}
inline bool GangZoneDestroy(int zone = None) {
  return sampgdk_GangZoneDestroy(zone);
}
inline bool GangZoneShowForPlayer(int playerid = None, int zone = None, int color = None) {
  return sampgdk_GangZoneShowForPlayer(playerid, zone, color);
}
inline bool GangZoneShowForAll(int zone = None, int color = None) {
  return sampgdk_GangZoneShowForAll(zone, color);
}
inline bool GangZoneHideForPlayer(int playerid = None, int zone = None) {
  return sampgdk_GangZoneHideForPlayer(playerid, zone);
}
inline bool GangZoneHideForAll(int zone = None) {
  return sampgdk_GangZoneHideForAll(zone);
}
inline bool GangZoneFlashForPlayer(int playerid = None, int zone = None, int flashcolor = None) {
  return sampgdk_GangZoneFlashForPlayer(playerid, zone, flashcolor);
}
inline bool GangZoneFlashForAll(int zone = None, int flashcolor = None) {
  return sampgdk_GangZoneFlashForAll(zone, flashcolor);
}
inline bool GangZoneStopFlashForPlayer(int playerid = None, int zone = None) {
  return sampgdk_GangZoneStopFlashForPlayer(playerid, zone);
}
inline bool GangZoneStopFlashForAll(int zone = None) {
  return sampgdk_GangZoneStopFlashForAll(zone);
}
inline int Create3DTextLabel(const char * text = None, int color = None, float x = None, float y = None, float z = None, float DrawDistance = None, int virtualworld = None, bool testLOS = false) {
  return sampgdk_Create3DTextLabel(text, color, x, y, z, DrawDistance, virtualworld, testLOS);
}
inline bool Delete3DTextLabel(int id = None) {
  return sampgdk_Delete3DTextLabel(id);
}
inline bool Attach3DTextLabelToPlayer(int id = None, int playerid = None, float OffsetX = None, float OffsetY = None, float OffsetZ = None) {
  return sampgdk_Attach3DTextLabelToPlayer(id, playerid, OffsetX, OffsetY, OffsetZ);
}
inline bool Attach3DTextLabelToVehicle(int id = None, int vehicleid = None, float OffsetX = None, float OffsetY = None, float OffsetZ = None) {
  return sampgdk_Attach3DTextLabelToVehicle(id, vehicleid, OffsetX, OffsetY, OffsetZ);
}
inline bool Update3DTextLabelText(int id = None, int color = None, const char * text = None) {
  return sampgdk_Update3DTextLabelText(id, color, text);
}
inline int CreatePlayer3DTextLabel(int playerid = None, const char * text = None, int color = None, float x = None, float y = None, float z = None, float DrawDistance = None, int attachedplayer = INVALID_PLAYER_ID, int attachedvehicle = INVALID_VEHICLE_ID, bool testLOS = false) {
  return sampgdk_CreatePlayer3DTextLabel(playerid, text, color, x, y, z, DrawDistance, attachedplayer, attachedvehicle, testLOS);
}
inline bool DeletePlayer3DTextLabel(int playerid = None, int id = None) {
  return sampgdk_DeletePlayer3DTextLabel(playerid, id);
}
inline bool UpdatePlayer3DTextLabelText(int playerid = None, int id = None, int color = None, const char * text = None) {
  return sampgdk_UpdatePlayer3DTextLabelText(playerid, id, color, text);
}
inline bool ShowPlayerDialog(int playerid = None, int dialogid = None, int style = None, const char * caption = None, const char * info = None, const char * button1 = None, const char * button2 = None) {
  return sampgdk_ShowPlayerDialog(playerid, dialogid, style, caption, info, button1, button2);
}
inline int SetTimer(int interval = None, bool repeat = None, TimerCallback callback = None, void * param = None) {
  return sampgdk_SetTimer(interval, repeat, callback, param);
}
inline bool KillTimer(int timerid = None) {
  return sampgdk_KillTimer(timerid);
}
inline bool gpci(int playerid = None, char * buffer = None, int size = None) {
...
#ifdef SAMPGDK_CPP_WRAPPERS
namespace sampgdk {
inline bool HTTP(int index = None, int type = None, const char * url = None, const char * data = None) {
