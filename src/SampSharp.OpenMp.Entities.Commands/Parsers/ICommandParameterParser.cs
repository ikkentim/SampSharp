...
public interface ICommandParameterParser
{
    ...
    /// <param name="inputText">Remaining input text as a StringSpan. Consumed text is removed by advancing the span.</param>
    /// <param name="result">Parsed value on success.</param>
    /// <returns><see langword="true" /> on success.</returns>
    bool TryParse(IServiceProvider services, ref StringSpan inputText, out object? result);
}