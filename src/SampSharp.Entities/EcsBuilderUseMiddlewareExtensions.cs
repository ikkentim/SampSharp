...
public static class EcsBuilderUseMiddlewareExtensions
{
    ...
    /// <summary>Adds a middleware of the specified type <typeparamref name="TMiddleware" /> to the handler of the event with the specified <paramref name="name" />.</summary>
    ...
    /// <summary>Adds a middleware of the specified type <paramref name="middleware" /> to the handler of the event with the specified <paramref name="name" />.</summary>
    /// <param name="builder">The ECS builder to add the middleware to.</param>
    /// <param name="name">The name of the event.</param>
    ...
    public static IEcsBuilder UseMiddleware(this IEcsBuilder builder, string name, Type middleware, params object[] args)
    {
        ...
        return builder.UseMiddleware(name, next =>
        {
            ...
            if (invokeMethods.Length != 1) throw new InvalidOperationException();
