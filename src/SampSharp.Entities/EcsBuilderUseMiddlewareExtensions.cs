...
namespace SampSharp.Entities
{
    ...
    public static class EcsBuilderUseMiddlewareExtensions
    {
        ...
        private static Func<T, EventContext, IServiceProvider, object> Compile<T>(MethodInfo methodInfo,
            ParameterInfo[] parameters)
        {
            ...
            var lambda =
                Expression.Lambda<Func<T, EventContext, IServiceProvider, object>>(body, instanceArg, eventContextArg,
                    providerArg);
