...
public class Player : Component
{
    ...
    public virtual string Name
    {
        get
        {
            GetComponent<NativePlayer>()
                .GetPlayerName(out var name, SampLimits.MaxPlayerNameLength);
            return name;
        }
        set => GetComponent<NativePlayer>()
            .SetPlayerName(value);
    }
    ...
    public virtual float Angle
    {
        ...
        {
            GetComponent<NativePlayer>()
                .GetPlayerFacingAngle(out var angle);
            return angle;
        }
        set => GetComponent<NativePlayer>()
            .SetPlayerFacingAngle(value);
    }
    ...
    public virtual float Health
    {
        ...
        {
            GetComponent<NativePlayer>()
                .GetPlayerHealth(out var health);
            return health;
        }
        set => GetComponent<NativePlayer>()
    ...
    public virtual float Armour
    {
        ...
        {
            GetComponent<NativePlayer>()
                .GetPlayerArmour(out var armour);
            return armour;
        }
        set => GetComponent<NativePlayer>()
    ...
    public virtual EntityId TargetPlayer
    {
        get
        {
            var id = GetComponent<NativePlayer>()
                .GetPlayerTargetPlayer();
            return id == NativePlayer.InvalidId
                ? EntityId.Empty
                : SampEntities.GetPlayerId(id);
        }
    }
    ...
    public virtual FightStyle FightStyle
    {
        ...
        set => GetComponent<NativePlayer>()
            .SetPlayerFightingStyle((int)value);
    }
    ...
    public virtual Vector3 Velocity
    {
        ...
        {
            GetComponent<NativePlayer>()
                .GetPlayerVelocity(out var x, out var y, out var z);
            return new Vector3(x, y, z);
        }
        set => GetComponent<NativePlayer>()
            .SetPlayerVelocity(value.X, value.Y, value.Z);
    }
    ...
    public virtual SpecialAction SpecialAction
    {
        ...
        set => GetComponent<NativePlayer>()
            .SetPlayerSpecialAction((int)value);
    }
    ...
    public virtual Vector3 CameraPosition
    {
        ...
        {
            GetComponent<NativePlayer>()
                .GetPlayerCameraPos(out var x, out var y, out var z);
            return new Vector3(x, y, z);
        }
        set => GetComponent<NativePlayer>()
            .SetPlayerCameraPos(value.X, value.Y, value.Z);
    }
    ...
    public virtual Vector3 CameraFrontVector
    {
        ...
        {
            GetComponent<NativePlayer>()
                .GetPlayerCameraFrontVector(out var x, out var y, out var z);
            return new Vector3(x, y, z);
        }
    }
    ...
    public virtual EntityId TargetActor
    {
        get
        {
            ...
            return id == NativeActor.InvalidId
                ? EntityId.Empty
                : SampEntities.GetActorId(id);
        }
    }
    ...
    public virtual EntityId CameraTargetGlobalObject
    {
        get
        {
            ...
            return id == NativeObject.InvalidId
                ? EntityId.Empty
    ...
    public virtual EntityId CameraTargetVehicle
    {
        get
        {
            ...
            return id == NativeVehicle.InvalidId
                ? EntityId.Empty
    ...
    public virtual EntityId CameraTargetEntity
    {
        get
        {
            ...
            if (id != NativeActor.InvalidId)
                return SampEntities.GetActorId(id);

            id = native.GetPlayerCameraTargetPlayer();

            if (id != NativePlayer.InvalidId)
                return SampEntities.GetPlayerId(id);

            id = native.GetPlayerCameraTargetVehicle();

            if (id != NativeVehicle.InvalidId)
                return SampEntities.GetVehicleId(id);

            id = GetComponent<NativePlayer>()
                .GetPlayerCameraTargetObject();

            if (id != NativePlayerObject.InvalidId)
                return Manager.Exists(SampEntities.GetObjectId(id))
                    ? SampEntities.GetObjectId(id)
                    : SampEntities.GetPlayerObjectId(Entity, id);
    ...
    public virtual EntityId Vehicle
    {
        ...
        {
            var id = GetComponent<NativePlayer>()
                .GetPlayerVehicleID(); //Returns 0, not NativeVehicle.InvalidId!
            return id == 0
                ? EntityId.Empty
                : SampEntities.GetVehicleId(id);
        }
    ...
    public virtual EntityId Menu
    {
        ...
        {
            var id = GetComponent<NativePlayer>()
                .GetPlayerMenu(); //Returns 0, not NativeVehicle.InvalidId!
            return id == NativeMenu.InvalidId
                ? EntityId.Empty
                : SampEntities.GetMenuId(id);
        }
    }
    ...
    public virtual Vector3 Position
    {
        ...
        {
            GetComponent<NativePlayer>()
                .GetPlayerPos(out var x, out var y, out var z);
            return new Vector3(x, y, z);
        }
        set => GetComponent<NativePlayer>()
            .SetPlayerPos(value.X, value.Y, value.Z);
    }
    ...
    public virtual string NetworkStats
    {
        ...
        {
            GetComponent<NativePlayer>()
                .GetPlayerNetworkStats(out var stats, 256);
            return stats;
        }
    }
    ...
    public virtual IPEndPoint EndPoint
    {
        get
        {
            var result = GetComponent<NativePlayer>()
                .GetIpPort(out var ipPort, 64);
            ...
            return !int.TryParse(portStr, out var port) || !IPAddress.TryParse(ipStr, out var ip)
                ? null
    ...
    public virtual string Version
    {
        ...
        {
            GetComponent<NativePlayer>()
                .GetPlayerVersion(out var version, 64);
            return version;
        }
    }
    ...
    {
        GetComponent<NativePlayer>()
            .SetSpawnInfo(team, skin, position.X, position.Y, position.Z, rotation, (int)weapon1, weapon1Ammo, (int)weapon2, weapon2Ammo, (int)weapon3,
                weapon3Ammo);
    }
    ...
    public virtual void PlayCrimeReport(EntityId suspect, int crime)
    {
        ...
        GetComponent<NativePlayer>()
            .PlayCrimeReportForPlayer(suspect, crime);
    }
    ...
    {
        return GetComponent<NativePlayer>()
            .SetPlayerAttachedObject(index, modelId, (int)bone, offset.X, offset.Y, offset.Z, rotation.X, rotation.Y, rotation.Z, scale.X, scale.Y, scale.Z,
    ...
    public virtual void PutInVehicle(EntityId vehicle, int seatId)
    {
        ...
        GetComponent<NativePlayer>()
            .PutPlayerInVehicle(vehicle, seatId);
    }
    ...
    public virtual void SetPlayerMarker(EntityId player, Color color)
    {
        ...
        GetComponent<NativePlayer>()
            .SetPlayerMarkerForPlayer(player, color.ToInteger(ColorFormat.RGBA));
    }
    ...
    public virtual void ShowNameTagForPlayer(EntityId player, bool show)
    {
        ...
        GetComponent<NativePlayer>()
            .ShowPlayerNameTagForPlayer(player, show);
    }
    ...
    public virtual void SpectatePlayer(EntityId targetPlayer, SpectateMode mode)
    {
        ...
        GetComponent<NativePlayer>()
            .PlayerSpectatePlayer(targetPlayer, (int)mode);
    }
    ...
    public virtual void SpectateVehicle(EntityId targetVehicle, SpectateMode mode)
    {
        ...
        GetComponent<NativePlayer>()
            .PlayerSpectateVehicle(targetVehicle, (int)mode);
    }
    ...
    public virtual void SendClientMessage(Color color, string message)
    {
        ...
        {
            GetComponent<NativePlayer>()
                .SendClientMessage(color.ToInteger(ColorFormat.RGBA), message);
        }
    }
    ...
    public virtual void SendPlayerMessageToPlayer(EntityId sender, string message)
    {
        ...
        GetComponent<NativePlayer>()
            .SendPlayerMessageToPlayer(sender, message);
    }
    ...
    public virtual void AttachCameraToObject(EntityId @object)
    {
        ...
        {
            var playerObject = Manager.GetComponent<NativePlayerObject>(@object);
            if (playerObject == null)
                throw new ArgumentException("Target must be of type object or player object", nameof(@object));
            GetComponent<NativePlayer>()
                .AttachCameraToPlayerObject(playerObject.Id);
        }
    }
    ...
    public virtual void Edit(EntityId @object)
    {
        ...
        if (@object.IsOfType(SampEntities.ObjectType))
            ...
            GetComponent<NativePlayer>()
                .EditPlayerObject(Manager.GetComponent<NativePlayerObject>(@object)
