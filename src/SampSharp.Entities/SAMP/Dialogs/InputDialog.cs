...
namespace SampSharp.Entities.SAMP.Dialogs
{
    ...
    public class InputDialog : IDialog<InputDialogResponse>
    {
        ...
        DialogStyle IDialog.Style => IsPassword ? DialogStyle.Password : DialogStyle.Input;
        ...
        /// <summary>
        /// Gets or sets the text on the right button of this input dialog. If the value is <c>null</c>, the right button is
        /// hidden.
        /// </summary>
