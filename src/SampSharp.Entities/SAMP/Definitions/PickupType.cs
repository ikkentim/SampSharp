...
namespace SampSharp.Entities.SAMP.Definitions
{
    ...
    {
        /// <summary>
        /// The pickup does not always display. If displayed, it can't be picked up and does not trigger OnPlayerPickUpPickup and
        /// it will stay after server shutdown.
        /// </summary>
        ShowButNotPickupable = 0,

        /// <summary>
        /// Exists always. Disables pickup scripts such as horseshoes and oysters to allow for scripted actions ONLY. Will trigger
        /// OnPlayerPickUpPickup every few seconds.
        /// </summary>
        ...
        /// <summary>
        /// Similar to type 1. Disappears when you take a picture of it with the Camera weapon, which triggers "Snapshot # out of
        /// 0" message. Taking a picture doesn't trigger OnPlayerPickUpPickup.
        /// </summary>
