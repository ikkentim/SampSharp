...
/// <summary>Contains functions for constructing <see cref="EntityId" /> values for SA:MP native entities.</summary>
public static class SampEntities
{
    /// <summary>The SA:MP actor entity type identifier.</summary>
    ...
    /// <summary>The SA:MP player entity type identifier.</summary>
    ...
    /// <summary>The SA:MP vehicle entity type identifier.</summary>
    ...
    /// <summary>The SA:MP gang zone entity type identifier.</summary>
    ...
    /// <summary>The SA:MP object entity type identifier.</summary>
    ...
    /// <summary>The SA:MP pickup entity type identifier.</summary>
    ...
    /// <summary>The SA:MP player object entity type identifier.</summary>
    ...
    /// <summary>The SA:MP player text label entity type identifier.</summary>
    ...
    /// <summary>The SA:MP text label entity type identifier.</summary>
    ...
    /// <summary>The SA:MP player text draw entity type identifier.</summary>
    [EntityType(InvalidHandle = NativePlayerTextDraw.InvalidId)]
    public static readonly Guid PlayerTextDrawType = new("2EBBB103-5FFC-44B2-97A5-FA5295A4BD14");

    /// <summary>The SA:MP text draw entity type identifier.</summary>
    ...
    /// <summary>The SA:MP menu entity type identifier.</summary>
    [EntityType(InvalidHandle = NativeObject.InvalidId)]
    public static readonly Guid MenuType = new("0AED0820-6CCF-4ED4-A879-8B161773769E");

    /// <summary>Gets a actor entity identifier based on an integer actor identifier.</summary>
    ...
    /// <summary>Gets a player entity identifier based on an integer player identifier.</summary>
    ...
    /// <summary>Gets a vehicle entity identifier based on an integer vehicle identifier.</summary>
    ...
    /// <summary>Gets a gang zone entity identifier based on an integer gang zone identifier.</summary>
    ...
    /// <summary>Gets a object entity identifier based on an integer object identifier.</summary>
    ...
    /// <summary>Gets a player object entity identifier based on an integer player object identifier.</summary>
    /// <param name="playerId">The player identifier.</param>
    ...
    /// <summary>Gets a pickup entity identifier based on an integer pickup identifier.</summary>
    ...
    /// <summary>Gets a player text label entity identifier based on an integer player text label identifier.</summary>
    /// <param name="playerId">The player identifier.</param>
    ...
    /// <summary>Gets a text label entity identifier based on an integer text label identifier.</summary>
    ...
    /// <summary>Gets a player text draw entity identifier based on an integer player text draw identifier.</summary>
    /// <param name="playerId">The player identifier.</param>
    ...
    /// <summary>Gets a text draw entity identifier based on an integer text draw identifier.</summary>
    ...
    /// <summary>Gets a menu entity identifier based on an integer menu identifier.</summary>
