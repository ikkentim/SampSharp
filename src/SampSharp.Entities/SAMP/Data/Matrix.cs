...
namespace SampSharp.Entities.SAMP
{
    ...
    public struct Matrix : IEquatable<Matrix>
    {
        ...
        public static Matrix Invert(Matrix matrix)
        {
            ...
            var num23 =
                (float) (matrix.M22 * (double) num17 - matrix.M23 * (double) num18 + matrix.M24 * (double) num19);
            var num24 = (float) -(matrix.M21 * (double) num17 - matrix.M23 * (double) num20 +
                                  matrix.M24 * (double) num21);
            var num25 =
                (float) (matrix.M21 * (double) num18 - matrix.M22 * (double) num20 + matrix.M24 * (double) num22);
            var num26 = (float) -(matrix.M21 * (double) num19 - matrix.M22 * (double) num21 +
                                  matrix.M23 * (double) num22);
            var num27 =
                (float)
                (1.0 /
            ...
            return new Matrix(
                num23 * num27,
                (float) -(matrix.M12 * (double) num17 - matrix.M13 * (double) num18 + matrix.M14 * (double) num19) *
                num27,
                (float) (matrix.M12 * (double) num28 - matrix.M13 * (double) num29 + matrix.M14 * (double) num30) *
                num27,
                (float) -(matrix.M12 * (double) num34 - matrix.M13 * (double) num35 + matrix.M14 * (double) num36) *
                num27,
                num24 * num27,
                (float) (matrix.M11 * (double) num17 - matrix.M13 * (double) num20 + matrix.M14 * (double) num21) *
                num27,
                (float) -(matrix.M11 * (double) num28 - matrix.M13 * (double) num31 + matrix.M14 * (double) num32) *
                num27,
                (float) (matrix.M11 * (double) num34 - matrix.M13 * (double) num37 + matrix.M14 * (double) num38) *
                num27,
                num25 * num27,
                (float) -(matrix.M11 * (double) num18 - matrix.M12 * (double) num20 + matrix.M14 * (double) num22) *
                num27,
                (float) (matrix.M11 * (double) num29 - matrix.M12 * (double) num31 + matrix.M14 * (double) num33) *
                num27,
                (float) -(matrix.M11 * (double) num35 - matrix.M12 * (double) num37 + matrix.M14 * (double) num39) *
                num27,
                num26 * num27,
                (float) (matrix.M11 * (double) num19 - matrix.M12 * (double) num21 + matrix.M13 * (double) num22) *
                num27,
                (float) -(matrix.M11 * (double) num30 - matrix.M12 * (double) num32 + matrix.M13 * (double) num33) *
                num27,
                (float) (matrix.M11 * (double) num36 - matrix.M12 * (double) num38 + matrix.M13 * (double) num39) *
                num27
            );
        }
