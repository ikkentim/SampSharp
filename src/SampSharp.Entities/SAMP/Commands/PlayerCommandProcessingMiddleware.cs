...
/// <summary>Represents a middleware which lets unhandled OnPlayerCommandText events be processed by the <see cref="IPlayerCommandService" />.</summary>
public class PlayerCommandProcessingMiddleware
{
    private readonly EventDelegate _next;

    /// <summary>Initializes a new instance of the <see cref="PlayerCommandProcessingMiddleware" /> class.</summary>
    ...
    public object Invoke(EventContext context, IPlayerCommandService commandService)
    {
        ...
        if (context.Arguments[0] is EntityId player && context.Arguments[1] is string text)
